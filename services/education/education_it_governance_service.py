    ...
    def _init_db(self):
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute(''' CREATE TABLE IF NOT EXISTS it_governance ( governance_id TEXT PRIMARY KEY, framework_type TEXT NOT NULL, education_type TEXT, name TEXT NOT NULL, description TEXT, scope TEXT, status TEXT DEFAULT 'active', established_date TEXT, review_frequency TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS governance_framework ( id INTEGER PRIMARY KEY AUTOINCREMENT, governance_id TEXT NOT NULL, framework_code TEXT NOT NULL, framework_name TEXT, adoption_level TEXT, implementation_status TEXT, last_review_date TEXT, next_review_date TEXT, FOREIGN KEY (governance_id) REFERENCES it_governance(governance_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS information_systems ( system_id TEXT PRIMARY KEY, system_code TEXT NOT NULL, system_name TEXT NOT NULL, education_type TEXT, description TEXT, vendor TEXT, version TEXT, deployment_status TEXT DEFAULT 'deployed', critical_level TEXT DEFAULT 'medium', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS system_catalog ( id INTEGER PRIMARY KEY AUTOINCREMENT, system_id TEXT NOT NULL, module_name TEXT NOT NULL, module_code TEXT, description TEXT, access_level TEXT, FOREIGN KEY (system_id) REFERENCES information_systems(system_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS technology_architecture ( architecture_id TEXT PRIMARY KEY, architecture_name TEXT NOT NULL, education_type TEXT, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS architecture_components ( id INTEGER PRIMARY KEY AUTOINCREMENT, architecture_id TEXT NOT NULL, component_name TEXT NOT NULL, component_type TEXT, vendor TEXT, version TEXT, status TEXT DEFAULT 'active', FOREIGN KEY (architecture_id) REFERENCES technology_architecture(architecture_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS data_governance ( governance_id TEXT PRIMARY KEY, governance_name TEXT NOT NULL, education_type TEXT, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS data_standards ( id INTEGER PRIMARY KEY AUTOINCREMENT, governance_id TEXT NOT NULL, standard_name TEXT NOT NULL, standard_code TEXT, description TEXT, status TEXT DEFAULT 'active', FOREIGN KEY (governance_id) REFERENCES data_governance(governance_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS security_governance ( security_id TEXT PRIMARY KEY, security_name TEXT NOT NULL, education_type TEXT, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS security_policies ( id INTEGER PRIMARY KEY AUTOINCREMENT, security_id TEXT NOT NULL, policy_name TEXT NOT NULL, policy_code TEXT, policy_type TEXT, description TEXT, status TEXT DEFAULT 'active', effective_date TEXT, FOREIGN KEY (security_id) REFERENCES security_governance(security_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS it_service_management ( service_id TEXT PRIMARY KEY, service_name TEXT NOT NULL, education_type TEXT, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS service_levels ( id INTEGER PRIMARY KEY AUTOINCREMENT, service_id TEXT NOT NULL, sla_name TEXT NOT NULL, sla_code TEXT, target_value TEXT, actual_value TEXT, status TEXT DEFAULT 'active', FOREIGN KEY (service_id) REFERENCES it_service_management(service_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS it_investment ( investment_id TEXT PRIMARY KEY, investment_name TEXT NOT NULL, education_type TEXT, budget_amount REAL DEFAULT 0, actual_amount REAL DEFAULT 0, status TEXT DEFAULT 'planning', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS investment_projects ( id INTEGER PRIMARY KEY AUTOINCREMENT, investment_id TEXT NOT NULL, project_name TEXT NOT NULL, project_code TEXT, budget REAL DEFAULT 0, actual_cost REAL DEFAULT 0, status TEXT DEFAULT 'pending', FOREIGN KEY (investment_id) REFERENCES it_investment(investment_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS it_performance ( performance_id TEXT PRIMARY KEY, performance_name TEXT NOT NULL, education_type TEXT, description TEXT, period TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS performance_metrics ( id INTEGER PRIMARY KEY AUTOINCREMENT, performance_id TEXT NOT NULL, metric_name TEXT NOT NULL, metric_code TEXT, target_value TEXT, actual_value TEXT, unit TEXT, FOREIGN KEY (performance_id) REFERENCES it_performance(performance_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS it_projects ( project_id TEXT PRIMARY KEY, project_name TEXT NOT NULL, education_type TEXT, description TEXT, status TEXT DEFAULT 'planning', priority TEXT DEFAULT 'medium', budget REAL DEFAULT 0, progress REAL DEFAULT 0, start_date TEXT, end_date TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS project_status ( id INTEGER PRIMARY KEY AUTOINCREMENT, project_id TEXT NOT NULL, status TEXT NOT NULL, status_date TEXT, comment TEXT, FOREIGN KEY (project_id) REFERENCES it_projects(project_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS it_assets ( asset_id TEXT PRIMARY KEY, asset_name TEXT NOT NULL, asset_type TEXT, education_type TEXT, location TEXT, status TEXT DEFAULT 'active', purchase_date TEXT, value REAL DEFAULT 0, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS asset_management ( id INTEGER PRIMARY KEY AUTOINCREMENT, asset_id TEXT NOT NULL, action_type TEXT NOT NULL, action_date TEXT, responsible TEXT, comment TEXT, FOREIGN KEY (asset_id) REFERENCES it_assets(asset_id) ) ''')
                conn.commit()
    ...
    def create_it_governance(self, framework_type: str, name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO it_governance ( governance_id, framework_type, education_type, name, description, scope, status, established_date, review_frequency, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, 'active', ?, ?, ?, ?) ''', (governance_id, framework_type, kwargs.get('education_type'), name,
    ...
    def add_governance_framework(self, governance_id: str, framework_code: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO governance_framework ( governance_id, framework_code, framework_name, adoption_level, implementation_status, last_review_date, next_review_date ) VALUES (?, ?, ?, ?, ?, ?, ?) ''', (governance_id, framework_code,
    ...
    def register_information_system(self, system_code: str, system_name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO information_systems ( system_id, system_code, system_name, education_type, description, vendor, version, deployment_status, critical_level, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (system_id, system_code, system_name,
    ...
    def create_technology_architecture(self, architecture_name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO technology_architecture ( architecture_id, architecture_name, education_type, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, 'active', ?, ?) ''', (architecture_id, architecture_name, kwargs.get('education_type'),
    ...
    def list_technology_architectures(self, education_type: str = None, status: str = None,
        ...
        try:
            with self._get_connection() as conn:
                ...
                return {'success': True, 'architectures': architectures, 'total': total, 'page': page,
                'page_size': page_size}
        except Exception as e:
    ...
    def create_data_governance(self, governance_name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO data_governance ( governance_id, governance_name, education_type, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, 'active', ?, ?) ''', (governance_id, governance_name, kwargs.get('education_type'),
                          kwargs.get('description'), now, now))
                    conn.commit()
    ...
    def create_security_governance(self, security_name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO security_governance ( security_id, security_name, education_type, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, 'active', ?, ?) ''', (security_id, security_name, kwargs.get('education_type'),
                          kwargs.get('description'), now, now))
                    conn.commit()
    ...
    def add_security_policy(self, security_id: str, policy_name: str, **kwargs) -> Dict[str, Any]:
        try:
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO security_policies ( security_id, policy_name, policy_code, policy_type, description, status, effective_date ) VALUES (?, ?, ?, ?, ?, ?, ?) ''', (security_id, policy_name, kwargs.get('policy_code'),
    ...
    def create_it_service(self, service_name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO it_service_management ( service_id, service_name, education_type, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, 'active', ?, ?) ''', (service_id, service_name, kwargs.get('education_type'),
                          kwargs.get('description'), now, now))
                    conn.commit()
    ...
    def create_it_investment(self, investment_name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO it_investment ( investment_id, investment_name, education_type, budget_amount, actual_amount, status, created_at, updated_at ) VALUES (?, ?, ?, ?, 0, ?, ?, ?) ''', (investment_id, investment_name, kwargs.get('education_type'),
    ...
    def create_it_performance(self, performance_name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO it_performance ( performance_id, performance_name, education_type, description, period, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, 'active', ?, ?) ''', (performance_id, performance_name, kwargs.get('education_type'),
    ...
    def create_it_project(self, project_name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO it_projects ( project_id, project_name, education_type, description, status, priority, budget, progress, start_date, end_date, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 0, ?, ?, ?, ?) ''', (project_id, project_name, kwargs.get('education_type'),
