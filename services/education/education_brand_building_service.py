...
class EducationBrandBuildingService:
    ...
    def _init_db(self):
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute(''' CREATE TABLE IF NOT EXISTS brand_elements ( id INTEGER PRIMARY KEY AUTOINCREMENT, school_id INTEGER NOT NULL, element_type TEXT NOT NULL, element_name TEXT, content TEXT, file_url TEXT, description TEXT, education_type TEXT, is_active INTEGER DEFAULT 1, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS brand_identity ( identity_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, brand_level TEXT, brand_name TEXT, brand_slogan TEXT, brand_positioning TEXT, target_audience TEXT, core_values TEXT, education_type TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS brand_assets ( asset_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, asset_type TEXT, asset_name TEXT, file_url TEXT, file_size INTEGER, format TEXT, description TEXT, usage_scope TEXT, education_type TEXT, uploaded_by INTEGER, uploaded_at TEXT, is_approved INTEGER DEFAULT 0, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS brand_guidelines ( guideline_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, guideline_name TEXT, version TEXT, content TEXT, file_url TEXT, applicable_level TEXT, education_type TEXT, is_active INTEGER DEFAULT 1, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS promotion_campaigns ( campaign_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, campaign_name TEXT, campaign_type TEXT, channels TEXT, target_audience TEXT, budget REAL DEFAULT 0, start_date TEXT, end_date TEXT, education_type TEXT, status TEXT DEFAULT 'planning', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS media_relations ( relation_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, media_name TEXT, media_type TEXT, contact_name TEXT, contact_phone TEXT, contact_email TEXT, relationship_level TEXT DEFAULT 'general', last_contact_date TEXT, education_type TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS media_coverage ( coverage_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, media_name TEXT, media_type TEXT, coverage_date TEXT, headline TEXT, content TEXT, url TEXT, coverage_type TEXT, education_type TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS brand_evaluations ( evaluation_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, evaluation_name TEXT, evaluation_period TEXT, dimensions TEXT, methodology TEXT, education_type TEXT, status TEXT DEFAULT 'planning', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS evaluation_results ( result_id TEXT PRIMARY KEY, evaluation_id TEXT NOT NULL, dimension TEXT, score REAL, weight REAL, weighted_score REAL, comment TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS brand_protection ( protection_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, protection_type TEXT, protection_name TEXT, status TEXT DEFAULT 'pending', registration_number TEXT, registration_date TEXT, expiration_date TEXT, education_type TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS trademark_records ( record_id TEXT PRIMARY KEY, protection_id TEXT NOT NULL, trademark_name TEXT, trademark_class INTEGER, registration_date TEXT, expiration_date TEXT, status TEXT DEFAULT 'pending', application_number TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS brand_collaborations ( collaboration_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, partner_name TEXT, partner_type TEXT, collaboration_type TEXT, start_date TEXT, end_date TEXT, description TEXT, education_type TEXT, status TEXT DEFAULT 'negotiating', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS collaboration_records ( record_id TEXT PRIMARY KEY, collaboration_id TEXT NOT NULL, activity_name TEXT, activity_date TEXT, description TEXT, outcome TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS brand_activities ( activity_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, activity_name TEXT, activity_type TEXT, location TEXT, start_date TEXT, end_date TEXT, start_time TEXT, end_time TEXT, max_participants INTEGER DEFAULT 100, registered_count INTEGER DEFAULT 0, description TEXT, education_type TEXT, status TEXT DEFAULT 'planned', cover_image TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS activity_participants ( id INTEGER PRIMARY KEY AUTOINCREMENT, activity_id TEXT NOT NULL, participant_id INTEGER, participant_name TEXT, participant_type TEXT, register_time TEXT, status TEXT DEFAULT 'registered', attended INTEGER DEFAULT 0, education_type TEXT, UNIQUE(activity_id, participant_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS brand_stories ( story_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, story_title TEXT, story_content TEXT, story_type TEXT, featured_image TEXT, education_type TEXT, is_published INTEGER DEFAULT 0, view_count INTEGER DEFAULT 0, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS brand_monitoring ( monitoring_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, monitor_type TEXT, monitor_keyword TEXT, source TEXT, sentiment TEXT, content TEXT, url TEXT, monitor_date TEXT, education_type TEXT, created_at TEXT ) ''')
                conn.commit()
    ...
    def create_brand_identity(self, school_id: int, brand_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO brand_identity ( identity_id, school_id, brand_level, brand_name, brand_slogan, brand_positioning, target_audience, core_values, education_type, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?) ''', (identity_id, school_id,
    ...
    def add_brand_element(self, school_id: int, element_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO brand_elements ( school_id, element_type, element_name, content, file_url, description, education_type, is_active, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 1, ?, ?) ''', (school_id, element_type, kwargs.get('element_name'),
    ...
    def upload_brand_asset(self, school_id: int, asset_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO brand_assets ( asset_id, school_id, asset_type, asset_name, file_url, file_size, format, description, usage_scope, education_type, uploaded_by, uploaded_at, is_approved, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, ?) ''', (asset_id, school_id, asset_type, asset_name,
    ...
    def create_brand_guideline(self, school_id: int, guideline_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO brand_guidelines ( guideline_id, school_id, guideline_name, version, content, file_url, applicable_level, education_type, is_active, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 1, ?, ?) ''', (guideline_id, school_id, guideline_name,
    ...
    def create_promotion_campaign(self, school_id: int, campaign_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO promotion_campaigns ( campaign_id, school_id, campaign_name, campaign_type, channels, target_audience, budget, start_date, end_date, education_type, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'planning', ?, ?) ''', (campaign_id, school_id, campaign_name, campaign_type,
    ...
    def add_media_relation(self, school_id: int, media_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO media_relations ( relation_id, school_id, media_name, media_type, contact_name, contact_phone, contact_email, relationship_level, last_contact_date, education_type, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (relation_id, school_id, media_name, media_type,
    ...
    def record_media_coverage(self, school_id: int, media_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO media_coverage ( coverage_id, school_id, media_name, media_type, coverage_date, headline, content, url, coverage_type, education_type, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (coverage_id, school_id, media_name, kwargs.get('media_type'),
    ...
    def create_brand_evaluation(self, school_id: int, evaluation_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO brand_evaluations ( evaluation_id, school_id, evaluation_name, evaluation_period, dimensions, methodology, education_type, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 'planning', ?, ?) ''', (evaluation_id, school_id, evaluation_name,
    ...
    def record_evaluation_result(self, evaluation_id: str, dimension: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO evaluation_results ( result_id, evaluation_id, dimension, score, weight, weighted_score, comment, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ''', (result_id, evaluation_id, dimension, score,
    ...
    def calculate_brand_score(self, evaluation_id: str) -> Dict[str, Any]:
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute('SELECT SUM(weighted_score), COUNT(*) FROM evaluation_results WHERE evaluation_id = ?',
                (evaluation_id,))
                ...
                cursor.execute('UPDATE brand_evaluations SET status = ? WHERE evaluation_id = ?', ('completed',
                evaluation_id))
                conn.commit()
    ...
    def create_protection_record(self, school_id: int, protection_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO brand_protection ( protection_id, school_id, protection_type, protection_name, status, registration_number, registration_date, expiration_date, education_type, created_at, updated_at ) VALUES (?, ?, ?, ?, 'pending', ?, ?, ?, ?, ?, ?) ''', (protection_id, school_id, protection_type, protection_name,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT INTO trademark_records ( record_id, protection_id, trademark_name, trademark_class, registration_date, expiration_date, status, application_number, created_at ) VALUES (?, ?, ?, ?, ?, ?, 'pending', ?, ?) ''', (record_id, protection_id, trademark_name, trademark_class,
    ...
    def create_collaboration(self, school_id: int, partner_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO brand_collaborations ( collaboration_id, school_id, partner_name, partner_type, collaboration_type, start_date, end_date, description, education_type, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'negotiating', ?, ?) ''', (collaboration_id, school_id, partner_name,
    ...
    def add_collaboration_record(self, collaboration_id: str, activity_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT collaboration_id FROM brand_collaborations WHERE collaboration_id = ?',
                    (collaboration_id,))
                    if not cursor.fetchone():
                        return {'success': False, 'error': '合作记录不存在'}
                    cursor.execute(''' INSERT INTO collaboration_records ( record_id, collaboration_id, activity_name, activity_date, description, outcome, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?) ''', (record_id, collaboration_id, activity_name, activity_date,
    ...
    def create_brand_activity(self, school_id: int, activity_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO brand_activities ( activity_id, school_id, activity_name, activity_type, location, start_date, end_date, start_time, end_time, max_participants, registered_count, description, education_type, status, cover_image, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, ?, 'planned', ?, ?, ?) ''', (activity_id, school_id, activity_name, activity_type,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT OR IGNORE INTO activity_participants ( activity_id, participant_id, participant_name, participant_type, register_time, status ) VALUES (?, ?, ?, ?, ?, 'registered') ''', (activity_id, participant_id, participant_name,
    ...
    def create_brand_story(self, school_id: int, story_title: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO brand_stories ( story_id, school_id, story_title, story_content, story_type, featured_image, education_type, is_published, view_count, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 0, 0, ?, ?) ''', (story_id, school_id, story_title, story_content,
