...
class EducationAdministrationService:
    ...
    def _init_db(self):
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute(''' CREATE TABLE IF NOT EXISTS admin_affairs ( affair_id TEXT PRIMARY KEY, affair_type TEXT NOT NULL, affair_title TEXT NOT NULL, education_type TEXT, priority TEXT DEFAULT 'normal', status TEXT DEFAULT 'pending', assignee_id INTEGER, assignee_name TEXT, description TEXT, deadline TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS affair_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, affair_id TEXT NOT NULL, action TEXT NOT NULL, operator_id INTEGER, operator_name TEXT, remark TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS personnel_management ( personnel_id TEXT PRIMARY KEY, personnel_type TEXT NOT NULL, name TEXT NOT NULL, education_type TEXT, gender TEXT, birth_date TEXT, id_card TEXT UNIQUE, position TEXT, department TEXT, status TEXT DEFAULT 'active', hire_date TEXT, salary REAL, phone TEXT, email TEXT, address TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS personnel_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, personnel_id TEXT NOT NULL, record_type TEXT NOT NULL, record_title TEXT, content TEXT, operator_id INTEGER, operator_name TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS financial_management ( finance_id TEXT PRIMARY KEY, finance_type TEXT NOT NULL, title TEXT NOT NULL, education_type TEXT, amount REAL DEFAULT 0, currency TEXT DEFAULT 'CNY', status TEXT DEFAULT 'pending', applicant_id INTEGER, applicant_name TEXT, department TEXT, description TEXT, document_no TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS financial_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, finance_id TEXT NOT NULL, action TEXT NOT NULL, amount REAL, operator_id INTEGER, operator_name TEXT, remark TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS asset_management ( asset_id TEXT PRIMARY KEY, asset_type TEXT NOT NULL, asset_name TEXT NOT NULL, education_type TEXT, category TEXT, brand TEXT, model TEXT, serial_no TEXT, purchase_date TEXT, purchase_price REAL, current_value REAL, location TEXT, responsible_id INTEGER, responsible_name TEXT, status TEXT DEFAULT 'in_use', depreciation_year INTEGER, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS asset_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, asset_id TEXT NOT NULL, action TEXT NOT NULL, operator_id INTEGER, operator_name TEXT, location_from TEXT, location_to TEXT, remark TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS archive_management ( archive_id TEXT PRIMARY KEY, archive_type TEXT NOT NULL, archive_name TEXT NOT NULL, education_type TEXT, category TEXT, file_path TEXT, file_size INTEGER, storage_location TEXT, is_available INTEGER DEFAULT 1, access_level TEXT DEFAULT 'public', creator_id INTEGER, creator_name TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS archive_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, archive_id TEXT NOT NULL, action TEXT NOT NULL, operator_id INTEGER, operator_name TEXT, borrow_days INTEGER, return_date TEXT, remark TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS meeting_management ( meeting_id TEXT PRIMARY KEY, meeting_type TEXT NOT NULL, meeting_title TEXT NOT NULL, education_type TEXT, location TEXT, start_time TEXT, end_time TEXT, organizer_id INTEGER, organizer_name TEXT, attendees TEXT, agenda TEXT, minutes TEXT, status TEXT DEFAULT 'scheduled', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS meeting_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, meeting_id TEXT NOT NULL, action TEXT NOT NULL, operator_id INTEGER, operator_name TEXT, content TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS document_management ( document_id TEXT PRIMARY KEY, document_type TEXT NOT NULL, document_title TEXT NOT NULL, education_type TEXT, content TEXT, sender_id INTEGER, sender_name TEXT, receiver TEXT, status TEXT DEFAULT 'draft', priority TEXT DEFAULT 'normal', document_no TEXT, signed_at TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS document_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, document_id TEXT NOT NULL, action TEXT NOT NULL, operator_id INTEGER, operator_name TEXT, status_before TEXT, status_after TEXT, remark TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS logistics_management ( logistics_id TEXT PRIMARY KEY, logistics_type TEXT NOT NULL, title TEXT NOT NULL, education_type TEXT, location TEXT, status TEXT DEFAULT 'pending', requester_id INTEGER, requester_name TEXT, assignee_id INTEGER, assignee_name TEXT, description TEXT, priority TEXT DEFAULT 'normal', cost REAL DEFAULT 0, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS logistics_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, logistics_id TEXT NOT NULL, action TEXT NOT NULL, operator_id INTEGER, operator_name TEXT, remark TEXT, created_at TEXT ) ''')
                conn.commit()
    ...
    def create_admin_affair(self, affair_type: str, affair_title: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO admin_affairs ( affair_id, affair_type, affair_title, education_type, priority, status, assignee_id, assignee_name, description, deadline, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (affair_id, affair_type, affair_title,
    ...
    def add_personnel(self, personnel_type: str, name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO personnel_management ( personnel_id, personnel_type, name, education_type, gender, birth_date, id_card, position, department, status, hire_date, salary, phone, email, address, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (personnel_id, personnel_type, name,
    ...
    def create_financial_item(self, finance_type: str, title: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO financial_management ( finance_id, finance_type, title, education_type, amount, currency, status, applicant_id, applicant_name, department, description, document_no, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (finance_id, finance_type, title,
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute('INSERT INTO financial_records (finance_id, action, amount, operator_id, operator_name, remark, created_at) VALUES (?, ?, ?, ?, ?, ?, ?)',
                                 (finance_id, status, kwargs.get('amount'), operator_id, operator_name,
    ...
    def add_asset(self, asset_type: str, asset_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO asset_management ( asset_id, asset_type, asset_name, education_type, category, brand, model, serial_no, purchase_date, purchase_price, current_value, location, responsible_id, responsible_name, status, depreciation_year, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (asset_id, asset_type, asset_name,
    ...
    def transfer_asset(self, asset_id: str, new_location: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT location, responsible_name FROM asset_management WHERE asset_id = ?',
                    (asset_id,))
                    ...
                    cursor.execute('INSERT INTO asset_records (asset_id, action, operator_id, operator_name, location_from, location_to, remark, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
                                 (asset_id, 'transfer', kwargs.get('operator_id'), kwargs.get('operator_name',
                                 'system'),
    ...
    def create_archive(self, archive_type: str, archive_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO archive_management ( archive_id, archive_type, archive_name, education_type, category, file_path, file_size, storage_location, is_available, access_level, creator_id, creator_name, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (archive_id, archive_type, archive_name,
                          kwargs.get('education_type'), kwargs.get('category'),
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute('INSERT INTO archive_records (archive_id, action, operator_id, operator_name, borrow_days, return_date, remark, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
                                 (archive_id, 'borrow', operator_id, operator_name, borrow_days, return_date, '借阅',
                                 now))
                    conn.commit()
    ...
    def create_meeting(self, meeting_type: str, meeting_title: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO meeting_management ( meeting_id, meeting_type, meeting_title, education_type, location, start_time, end_time, organizer_id, organizer_name, attendees, agenda, minutes, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (meeting_id, meeting_type, meeting_title,
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute('INSERT INTO meeting_records (meeting_id, action, operator_id, operator_name, content, created_at) VALUES (?, ?, ?, ?, ?, ?)',
                                 (meeting_id, 'update', kwargs.get('operator_id'), kwargs.get('operator_name',
                                 'system'), json.dumps(kwargs, ensure_ascii=False), now))
                    conn.commit()
                    return {'success': True}
        except Exception as e:
    ...
    def create_document(self, document_type: str, document_title: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO document_management ( document_id, document_type, document_title, education_type, content, sender_id, sender_name, receiver, status, priority, document_no, signed_at, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (document_id, document_type, document_title,
    ...
    def process_document(self, document_id: str, action: str,
        ...
        try:
            now = datetime.now().isoformat()
            status_map = {'submit': 'submitted', 'approve': 'approved', 'reject': 'rejected', 'sign': 'signed',
            'publish': 'published'}
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute('INSERT INTO document_records (document_id, action, operator_id, operator_name, status_before, status_after, remark, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
                                 (document_id, action, operator_id, operator_name, old_status, new_status,
                                 kwargs.get('remark'), now))
                    conn.commit()
                    return {'success': True, 'status': new_status}
        except Exception as e:
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute('INSERT INTO document_records (document_id, action, operator_id, operator_name, status_before, status_after, remark, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
                                 (document_id, 'distribute', operator_id, operator_name, 'published', 'distributed',
                                 f'已分发至: {receiver}', now))
                    conn.commit()
                    return {'success': True}
        except Exception as e:
    ...
    def create_logistics_request(self, logistics_type: str, title: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO logistics_management ( logistics_id, logistics_type, title, education_type, location, status, requester_id, requester_name, assignee_id, assignee_name, description, priority, cost, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (logistics_id, logistics_type, title,
                          kwargs.get('education_type'), kwargs.get('location'),
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(f'UPDATE logistics_management SET {", ".join(updates)} WHERE logistics_id = ?',
                    params)
                    cursor.execute('INSERT INTO logistics_records (logistics_id, action, operator_id, operator_name, remark, created_at) VALUES (?, ?, ?, ?, ?, ?)',
                                 (logistics_id, 'complete', operator_id, operator_name, kwargs.get('remark', '任务已完成'),
                                 now))
                    conn.commit()
                    return {'success': True}
        except Exception as e:
