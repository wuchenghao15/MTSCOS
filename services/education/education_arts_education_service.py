    ...
    def _init_db(self):
        try:
            with self._get_connection() as conn:
                ...
                cursor.execute(''' CREATE TABLE IF NOT EXISTS music_education ( course_id TEXT PRIMARY KEY, course_name TEXT NOT NULL, music_type TEXT NOT NULL, education_type TEXT NOT NULL, grade_level INTEGER, teacher_id INTEGER, teacher_name TEXT, semester TEXT, weekly_hours INTEGER DEFAULT 2, location TEXT, max_students INTEGER DEFAULT 30, enrolled_count INTEGER DEFAULT 0, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS music_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, course_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, enroll_date TEXT, attendance_count INTEGER DEFAULT 0, final_score REAL, grade TEXT, feedback TEXT, UNIQUE(course_id, student_id) ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS art_education ( course_id TEXT PRIMARY KEY, course_name TEXT NOT NULL, art_type TEXT NOT NULL, education_type TEXT NOT NULL, grade_level INTEGER, teacher_id INTEGER, teacher_name TEXT, semester TEXT, weekly_hours INTEGER DEFAULT 2, location TEXT, max_students INTEGER DEFAULT 30, enrolled_count INTEGER DEFAULT 0, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS art_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, course_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, enroll_date TEXT, attendance_count INTEGER DEFAULT 0, final_score REAL, grade TEXT, feedback TEXT, UNIQUE(course_id, student_id) ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS dance_education ( course_id TEXT PRIMARY KEY, course_name TEXT NOT NULL, dance_type TEXT NOT NULL, education_type TEXT NOT NULL, grade_level INTEGER, teacher_id INTEGER, teacher_name TEXT, semester TEXT, weekly_hours INTEGER DEFAULT 2, location TEXT, max_students INTEGER DEFAULT 30, enrolled_count INTEGER DEFAULT 0, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS dance_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, course_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, enroll_date TEXT, attendance_count INTEGER DEFAULT 0, final_score REAL, grade TEXT, feedback TEXT, UNIQUE(course_id, student_id) ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS theater_education ( course_id TEXT PRIMARY KEY, course_name TEXT NOT NULL, theater_type TEXT NOT NULL, education_type TEXT NOT NULL, grade_level INTEGER, teacher_id INTEGER, teacher_name TEXT, semester TEXT, weekly_hours INTEGER DEFAULT 2, location TEXT, max_students INTEGER DEFAULT 30, enrolled_count INTEGER DEFAULT 0, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS theater_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, course_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, enroll_date TEXT, attendance_count INTEGER DEFAULT 0, final_score REAL, grade TEXT, feedback TEXT, UNIQUE(course_id, student_id) ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS film_education ( course_id TEXT PRIMARY KEY, course_name TEXT NOT NULL, film_type TEXT NOT NULL, education_type TEXT NOT NULL, grade_level INTEGER, teacher_id INTEGER, teacher_name TEXT, semester TEXT, weekly_hours INTEGER DEFAULT 2, location TEXT, max_students INTEGER DEFAULT 30, enrolled_count INTEGER DEFAULT 0, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS film_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, course_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, enroll_date TEXT, attendance_count INTEGER DEFAULT 0, final_score REAL, grade TEXT, feedback TEXT, UNIQUE(course_id, student_id) ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS calligraphy_education ( course_id TEXT PRIMARY KEY, course_name TEXT NOT NULL, calligraphy_type TEXT NOT NULL, education_type TEXT NOT NULL, grade_level INTEGER, teacher_id INTEGER, teacher_name TEXT, semester TEXT, weekly_hours INTEGER DEFAULT 2, location TEXT, max_students INTEGER DEFAULT 30, enrolled_count INTEGER DEFAULT 0, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS calligraphy_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, course_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, enroll_date TEXT, attendance_count INTEGER DEFAULT 0, final_score REAL, grade TEXT, feedback TEXT, UNIQUE(course_id, student_id) ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS art_appreciation ( program_id TEXT PRIMARY KEY, program_name TEXT NOT NULL, appreciation_type TEXT NOT NULL, education_type TEXT NOT NULL, grade_level INTEGER, instructor_id INTEGER, instructor_name TEXT, description TEXT, content TEXT, duration INTEGER DEFAULT 90, max_participants INTEGER DEFAULT 50, registered_count INTEGER DEFAULT 0, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS appreciation_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, program_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, register_date TEXT, completed INTEGER DEFAULT 0, score REAL, feedback TEXT, UNIQUE(program_id, student_id) ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS art_creation ( project_id TEXT PRIMARY KEY, project_name TEXT NOT NULL, creation_type TEXT NOT NULL, education_type TEXT NOT NULL, grade_level INTEGER, teacher_id INTEGER, teacher_name TEXT, description TEXT, requirements TEXT, deadline TEXT, max_participants INTEGER DEFAULT 30, enrolled_count INTEGER DEFAULT 0, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')

                cursor.execute(''' CREATE TABLE IF NOT EXISTS creation_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, project_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, enroll_date TEXT, submission_url TEXT, submission_date TEXT, score REAL, grade TEXT, feedback TEXT, status TEXT DEFAULT 'pending', UNIQUE(project_id, student_id) ) ''')
    ...
    def create_music_course(self, course_name: str, music_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO music_education ( course_id, course_name, music_type, education_type, grade_level, teacher_id, teacher_name, semester, weekly_hours, location, max_students, enrolled_count, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, 'active', ?, ?) ''', (course_id, course_name, music_type, education_type,
        ...
        try:
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                    'UPDATE music_records SET attendance_count = attendance_count + ? WHERE course_id = ? AND  student_id = ?',
    ...
    def create_art_course(self, course_name: str, art_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO art_education ( course_id, course_name, art_type, education_type, grade_level, teacher_id, teacher_name, semester, weekly_hours, location, max_students, enrolled_count, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, 'active', ?, ?) ''', (course_id, course_name, art_type, education_type,
                          kwargs.get('grade_level'), kwargs.get('teacher_id'),
                          kwargs.get('teacher_name'), kwargs.get('semester'),
                          kwargs.get('weekly_hours', 2), kwargs.get('location'),
                          kwargs.get('max_students', 30), kwargs.get('description'),
    ...
    def enroll_art_course(self, course_id: str, student_id: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT max_students, enrolled_count, status FROM art_education WHERE course_id = ?',
                    (course_id,))
                    course = cursor.fetchone()
                    if not course:
                        return {'success': False, 'error': '课程不存在'}
        ...
        try:
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                    'UPDATE art_records SET attendance_count = attendance_count + ? WHERE course_id = ? AND student_id  = ?',
                                 (attendance_count, course_id, student_id))
                    if cursor.rowcount > 0:
                        conn.commit()
                        return {'success': True}
    ...
    def create_dance_course(self, course_name: str, dance_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO dance_education ( course_id, course_name, dance_type, education_type, grade_level, teacher_id, teacher_name, semester, weekly_hours, location, max_students, enrolled_count, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, 'active', ?, ?) ''', (course_id, course_name, dance_type, education_type,
                          kwargs.get('grade_level'), kwargs.get('teacher_id'),
                          kwargs.get('teacher_name'), kwargs.get('semester'),
                          kwargs.get('weekly_hours', 2), kwargs.get('location'),
                          kwargs.get('max_students', 30), kwargs.get('description'),
        ...
        try:
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                    'UPDATE dance_records SET attendance_count = attendance_count + ? WHERE course_id = ? AND  student_id = ?',
                                 (attendance_count, course_id, student_id))
                    if cursor.rowcount > 0:
                        conn.commit()
                        return {'success': True}
    ...
    def create_theater_course(self, course_name: str, theater_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO theater_education ( course_id, course_name, theater_type, education_type, grade_level, teacher_id, teacher_name, semester, weekly_hours, location, max_students, enrolled_count, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, 'active', ?, ?) ''', (course_id, course_name, theater_type, education_type,
                          kwargs.get('grade_level'), kwargs.get('teacher_id'),
                          kwargs.get('teacher_name'), kwargs.get('semester'),
                          kwargs.get('weekly_hours', 2), kwargs.get('location'),
                          kwargs.get('max_students', 30), kwargs.get('description'),
        ...
        try:
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                    'UPDATE theater_records SET attendance_count = attendance_count + ? WHERE course_id = ? AND  student_id = ?',
                                 (attendance_count, course_id, student_id))
                    if cursor.rowcount > 0:
                        conn.commit()
                        return {'success': True}
    ...
    def create_theater_performance(self, course_id: str, title: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO theater_performances ( perf_id, course_id, title, performance_date, location, description, max_seats, seats_sold, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 0, 'scheduled', ?, ?) ''', (perf_id, course_id, title, performance_date,
    ...
    def create_film_course(self, course_name: str, film_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO film_education ( course_id, course_name, film_type, education_type, grade_level, teacher_id, teacher_name, semester, weekly_hours, location, max_students, enrolled_count, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, 'active', ?, ?) ''', (course_id, course_name, film_type, education_type,
                          kwargs.get('grade_level'), kwargs.get('teacher_id'),
                          kwargs.get('teacher_name'), kwargs.get('semester'),
                          kwargs.get('weekly_hours', 2), kwargs.get('location'),
                          kwargs.get('max_students', 30), kwargs.get('description'),
        ...
        try:
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                    'UPDATE film_records SET attendance_count = attendance_count + ? WHERE course_id = ? AND student_id  = ?',
                                 (attendance_count, course_id, student_id))
                    if cursor.rowcount > 0:
                        conn.commit()
                        return {'success': True}
    ...
    def create_calligraphy_course(self, course_name: str, calligraphy_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO calligraphy_education ( course_id, course_name, calligraphy_type, education_type, grade_level, teacher_id, teacher_name, semester, weekly_hours, location, max_students, enrolled_count, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, 'active', ?, ?) ''', (course_id, course_name, calligraphy_type, education_type,
                          kwargs.get('grade_level'), kwargs.get('teacher_id'),
                          kwargs.get('teacher_name'), kwargs.get('semester'),
                          kwargs.get('weekly_hours', 2), kwargs.get('location'),
                          kwargs.get('max_students', 30), kwargs.get('description'),
        ...
        try:
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                    'UPDATE calligraphy_records SET attendance_count = attendance_count + ? WHERE course_id = ? AND  student_id = ?',
                                 (attendance_count, course_id, student_id))
                    if cursor.rowcount > 0:
                        conn.commit()
                        return {'success': True}
    ...
    def create_appreciation_program(self, program_name: str, appreciation_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO art_appreciation ( program_id, program_name, appreciation_type, education_type, grade_level, instructor_id, instructor_name, description, content, duration, max_participants, registered_count, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, 'active', ?, ?) ''', (program_id, program_name, appreciation_type, education_type,
        ...
        try:
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                    'UPDATE appreciation_records SET completed = 1 WHERE program_id = ? AND student_id = ?',
    ...
    def create_creation_project(self, project_name: str, creation_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO art_creation ( project_id, project_name, creation_type, education_type, grade_level, teacher_id, teacher_name, description, requirements, deadline, max_participants, enrolled_count, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, 'active', ?, ?) ''', (project_id, project_name, creation_type, education_type,
                          kwargs.get('grade_level'), kwargs.get('teacher_id'),
