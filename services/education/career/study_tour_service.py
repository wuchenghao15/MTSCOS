    ...
    def _init_db(self):
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute(''' CREATE TABLE IF NOT EXISTS study_bases ( base_id TEXT PRIMARY KEY, base_name TEXT NOT NULL, base_type TEXT NOT NULL, organization TEXT, address TEXT, city TEXT, contact_person TEXT, contact_phone TEXT, capacity INTEGER DEFAULT 50, facilities TEXT, courses TEXT, certification TEXT, certification_date TEXT, rating REAL DEFAULT 0, review_count INTEGER DEFAULT 0, introduction TEXT, photos TEXT, is_approved INTEGER DEFAULT 0, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS study_routes ( route_id TEXT PRIMARY KEY, route_name TEXT NOT NULL, tour_type TEXT NOT NULL, base_ids TEXT, theme TEXT, description TEXT, duration_days INTEGER DEFAULT 3, difficulty TEXT DEFAULT 'medium', target_age TEXT, target_grade TEXT, price REAL DEFAULT 0, itinerary TEXT, learning_objectives TEXT, included_services TEXT, excluded_services TEXT, status TEXT DEFAULT 'draft', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS study_tours ( tour_id TEXT PRIMARY KEY, tour_name TEXT NOT NULL, route_id TEXT, tour_type TEXT NOT NULL, organizer_id INTEGER, organizer_name TEXT, start_date TEXT, end_date TEXT, gathering_place TEXT, gathering_time TEXT, max_participants INTEGER DEFAULT 50, min_participants INTEGER DEFAULT 10, registered_count INTEGER DEFAULT 0, price REAL DEFAULT 0, registration_deadline TEXT, status TEXT DEFAULT 'planning', description TEXT, requirements TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS tour_registrations ( registration_id TEXT PRIMARY KEY, tour_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, grade TEXT, parent_id INTEGER, parent_name TEXT, emergency_contact TEXT, emergency_phone TEXT, health_condition TEXT, special_needs TEXT, register_time TEXT, fee_paid REAL DEFAULT 0, paid_time TEXT, status TEXT DEFAULT 'registered', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS tour_courses ( course_id TEXT PRIMARY KEY, tour_id TEXT NOT NULL, base_id TEXT, course_name TEXT NOT NULL, course_type TEXT, description TEXT, objectives TEXT, content TEXT, duration_hours REAL DEFAULT 2, instructor_id INTEGER, instructor_name TEXT, materials TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS study_tasks ( task_id TEXT PRIMARY KEY, course_id TEXT NOT NULL, tour_id TEXT NOT NULL, task_name TEXT NOT NULL, task_type TEXT NOT NULL, description TEXT, requirements TEXT, deliverable_format TEXT, deadline TEXT, difficulty TEXT DEFAULT 'medium', is_group_work INTEGER DEFAULT 0, group_size INTEGER DEFAULT 1, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS task_submissions ( submission_id TEXT PRIMARY KEY, task_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, group_members TEXT, content TEXT, file_url TEXT, submit_time TEXT, score REAL, feedback TEXT, graded_by INTEGER, graded_at TEXT, status TEXT DEFAULT 'submitted', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS tour_safety_plans ( plan_id TEXT PRIMARY KEY, tour_id TEXT NOT NULL, safety_level TEXT NOT NULL, risk_assessment TEXT, prevention_measures TEXT, emergency_procedures TEXT, emergency_contacts TEXT, medical_arrangements TEXT, evacuation_plan TEXT, prepared_by INTEGER, prepared_at TEXT, approved_by INTEGER, approved_at TEXT, status TEXT DEFAULT 'draft', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS tour_insurances ( insurance_id TEXT PRIMARY KEY, tour_id TEXT NOT NULL, registration_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, insurance_type TEXT NOT NULL, provider TEXT, policy_number TEXT, coverage_amount REAL DEFAULT 0, start_date TEXT, end_date TEXT, premium REAL DEFAULT 0, status TEXT DEFAULT 'active', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS safety_inspections ( inspection_id TEXT PRIMARY KEY, tour_id TEXT NOT NULL, inspector_id INTEGER, inspector_name TEXT, inspection_date TEXT, inspection_items TEXT, issues_found TEXT, risk_level TEXT, suggestions TEXT, status TEXT DEFAULT 'completed', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS emergency_events ( event_id TEXT PRIMARY KEY, tour_id TEXT NOT NULL, event_type TEXT NOT NULL, occurred_at TEXT, location TEXT, description TEXT, involved_students TEXT, severity TEXT, response_actions TEXT, handled_by INTEGER, handled_at TEXT, outcome TEXT, reported_to_parent INTEGER DEFAULT 0, follow_up TEXT, status TEXT DEFAULT 'open', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS tour_achievements ( achievement_id TEXT PRIMARY KEY, tour_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, achievement_type TEXT NOT NULL, title TEXT NOT NULL, description TEXT, file_url TEXT, group_members TEXT, rating REAL DEFAULT 0, evaluated_by INTEGER, evaluated_at TEXT, is_excellent INTEGER DEFAULT 0, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS tour_evaluations ( evaluation_id TEXT PRIMARY KEY, tour_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, evaluator_type TEXT NOT NULL, dimension_scores TEXT, total_score REAL DEFAULT 0, grade TEXT, comment TEXT, suggestions TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS study_instructors ( instructor_id TEXT PRIMARY KEY, user_id INTEGER, name TEXT NOT NULL, title TEXT, specialties TEXT, certifications TEXT, base_affiliation TEXT, tour_count INTEGER DEFAULT 0, total_students INTEGER DEFAULT 0, rating REAL DEFAULT 0, rating_count INTEGER DEFAULT 0, training_hours REAL DEFAULT 0, is_active INTEGER DEFAULT 1, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS tour_reflections ( reflection_id TEXT PRIMARY KEY, tour_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, reflection_type TEXT DEFAULT 'daily', content TEXT NOT NULL, mood TEXT, gains TEXT, improvements TEXT, created_at TEXT ) ''')
                conn.commit()
    ...
    def register_study_base(self, base_name: str, base_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO study_bases ( base_id, base_name, base_type, organization, address, city, contact_person, contact_phone, capacity, facilities, courses, certification, certification_date, rating, review_count, introduction, photos, is_approved, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, 0, ?, ?, 0, ?, ?) ''', (base_id, base_name, base_type,
    ...
    def approve_study_base(self, base_id: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' UPDATE study_bases SET is_approved = ?, certification = ?, certification_date = ?, updated_at = ? WHERE base_id = ? ''', (is_approved, kwargs.get('certification'),
    ...
    def create_study_route(self, route_name: str, tour_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO study_routes ( route_id, route_name, tour_type, base_ids, theme, description, duration_days, difficulty, target_age, target_grade, price, itinerary, learning_objectives, included_services, excluded_services, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (route_id, route_name, tour_type,
    ...
    def create_study_tour(self, tour_name: str, route_id: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO study_tours ( tour_id, tour_name, route_id, tour_type, organizer_id, organizer_name, start_date, end_date, gathering_place, gathering_time, max_participants, min_participants, registered_count, price, registration_deadline, status, description, requirements, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, ?, ?, ?, ?, ?, ?) ''', (tour_id, tour_name, route_id, tour_type,
    ...
    def register_tour(self, tour_id: str, student_id: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' SELECT max_participants, registered_count, status, registration_deadline, price FROM study_tours WHERE tour_id = ? ''', (tour_id,))
                    ...
                    cursor.execute(''' SELECT registration_id FROM tour_registrations WHERE tour_id = ? AND student_id = ? AND status != 'cancelled' ''', (tour_id, student_id))
                    if cursor.fetchone():
                        return {'success': False, 'error': '已报名该活动'}
                    registration_id = f"reg_{uuid.uuid4().hex[:12]}"
                    cursor.execute(''' INSERT INTO tour_registrations ( registration_id, tour_id, student_id, student_name, grade, parent_id, parent_name, emergency_contact, emergency_phone, health_condition, special_needs, register_time, fee_paid, paid_time, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'registered', ?, ?) ''', (registration_id, tour_id, student_id,
    ...
    def add_tour_course(self, tour_id: str, course_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO tour_courses ( course_id, tour_id, base_id, course_name, course_type, description, objectives, content, duration_hours, instructor_id, instructor_name, materials, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (course_id, tour_id, kwargs.get('base_id'),
    ...
    def create_study_task(self, course_id: str, task_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO study_tasks ( task_id, course_id, tour_id, task_name, task_type, description, requirements, deliverable_format, deadline, difficulty, is_group_work, group_size, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (task_id, course_id, kwargs.get('tour_id'),
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT INTO task_submissions ( submission_id, task_id, student_id, student_name, group_members, content, file_url, submit_time, score, feedback, graded_by, graded_at, status, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NULL, NULL, NULL, NULL, 'submitted', ?) ''', (submission_id, task_id, student_id,
    ...
    def grade_task(self, submission_id: str, score: float,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' UPDATE task_submissions SET score = ?, feedback = ?, graded_by = ?, graded_at = ?, status = 'graded' WHERE submission_id = ? AND status = 'submitted' ''', (score, kwargs.get('feedback'),
    ...
    def create_safety_plan(self, tour_id: str, safety_level: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO tour_safety_plans ( plan_id, tour_id, safety_level, risk_assessment, prevention_measures, emergency_procedures, emergency_contacts, medical_arrangements, evacuation_plan, prepared_by, prepared_at, approved_by, approved_at, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NULL, NULL, 'draft', ?, ?) ''', (plan_id, tour_id, safety_level,
    ...
    def approve_safety_plan(self, plan_id: str, approved_by: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' UPDATE tour_safety_plans SET approved_by = ?, approved_at = ?, status = ?, updated_at = ? WHERE plan_id = ? AND status = 'draft' ''', (approved_by, now, status, now, plan_id))
                    if cursor.rowcount > 0:
                        conn.commit()
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT INTO tour_insurances ( insurance_id, tour_id, registration_id, student_id, student_name, insurance_type, provider, policy_number, coverage_amount, start_date, end_date, premium, status, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', ?) ''', (insurance_id, tour_id, registration_id, reg[0], reg[1],
    ...
    def conduct_safety_inspection(self, tour_id: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO safety_inspections ( inspection_id, tour_id, inspector_id, inspector_name, inspection_date, inspection_items, issues_found, risk_level, suggestions, status, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (inspection_id, tour_id, kwargs.get('inspector_id'),
    ...
    def report_emergency(self, tour_id: str, event_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO emergency_events ( event_id, tour_id, event_type, occurred_at, location, description, involved_students, severity, response_actions, handled_by, handled_at, outcome, reported_to_parent, follow_up, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, NULL, NULL, NULL, ?, NULL, 'open', ?, ?) ''', (event_id, tour_id, event_type,
    ...
    def handle_emergency(self, event_id: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' UPDATE emergency_events SET response_actions = ?, handled_by = ?, handled_at = ?, outcome = ?, reported_to_parent = ?, follow_up = ?, status = 'resolved', updated_at = ? WHERE event_id = ? AND status = 'open' ''', (json.dumps(kwargs.get('response_actions', []), ensure_ascii=False),
    ...
    def record_achievement(self, tour_id: str, student_id: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO tour_achievements ( achievement_id, tour_id, student_id, student_name, achievement_type, title, description, file_url, group_members, rating, evaluated_by, evaluated_at, is_excellent, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (achievement_id, tour_id, student_id,
    ...
    def create_evaluation(self, tour_id: str, student_id: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO tour_evaluations ( evaluation_id, tour_id, student_id, student_name, evaluator_type, dimension_scores, total_score, grade, comment, suggestions, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (evaluation_id, tour_id, student_id,
    ...
    def add_reflection(self, tour_id: str, student_id: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO tour_reflections ( reflection_id, tour_id, student_id, student_name, reflection_type, content, mood, gains, improvements, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (reflection_id, tour_id, student_id,
                          kwargs.get('student_name'),
    ...
    def register_instructor(self, name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO study_instructors ( instructor_id, user_id, name, title, specialties, certifications, base_affiliation, tour_count, total_students, rating, rating_count, training_hours, is_active, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 0, 0, 0, 0, ?, 1, ?, ?) ''', (instructor_id, kwargs.get('user_id'), name,
                          kwargs.get('title'),
