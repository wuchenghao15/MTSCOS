    ...
    def _init_db(self):
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute(''' CREATE TABLE IF NOT EXISTS international_programs ( program_id TEXT PRIMARY KEY, program_name TEXT NOT NULL, program_type TEXT NOT NULL, education_type TEXT, description TEXT, partner_institution TEXT, partner_id TEXT, duration TEXT, start_date TEXT, end_date TEXT, max_students INTEGER DEFAULT 30, enrolled_count INTEGER DEFAULT 0, tuition_fee REAL, language_requirement TEXT, application_deadline TEXT, eligibility TEXT, status TEXT DEFAULT 'open', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS program_partners ( id INTEGER PRIMARY KEY AUTOINCREMENT, program_id TEXT NOT NULL, partner_id TEXT NOT NULL, partnership_type TEXT, start_date TEXT, end_date TEXT, status TEXT DEFAULT 'active', UNIQUE(program_id, partner_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS international_courses ( course_id TEXT PRIMARY KEY, course_name TEXT NOT NULL, course_code TEXT, program_id TEXT, education_type TEXT, grade_level INTEGER, language TEXT, credits REAL, instructor TEXT, instructor_id INTEGER, semester TEXT, weekly_hours INTEGER DEFAULT 3, max_students INTEGER DEFAULT 25, enrolled_count INTEGER DEFAULT 0, description TEXT, is_credit_recognized INTEGER DEFAULT 0, partner_institution TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS course_enrollments ( id INTEGER PRIMARY KEY AUTOINCREMENT, course_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, student_type TEXT, education_type TEXT, enroll_date TEXT, final_score REAL, grade TEXT, credits_earned REAL, status TEXT DEFAULT 'enrolled', UNIQUE(course_id, student_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS exchange_students ( exchange_id TEXT PRIMARY KEY, student_id INTEGER NOT NULL, student_name TEXT, student_type TEXT, education_type TEXT, home_institution TEXT, host_institution TEXT, host_institution_id TEXT, program_id TEXT, exchange_type TEXT, start_date TEXT, end_date TEXT, duration TEXT, language_level TEXT, credits_transferred REAL, status TEXT DEFAULT 'pending', application_date TEXT, acceptance_date TEXT, departure_date TEXT, return_date TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS exchange_applications ( application_id TEXT PRIMARY KEY, student_id INTEGER NOT NULL, program_id TEXT NOT NULL, exchange_type TEXT, host_institution TEXT, personal_statement TEXT, recommendation_letter TEXT, academic_transcript TEXT, language_proof TEXT, application_status TEXT DEFAULT 'submitted', review_comments TEXT, submitted_at TEXT, reviewed_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS international_exams ( exam_id TEXT PRIMARY KEY, exam_type TEXT NOT NULL, exam_name TEXT, exam_date TEXT, registration_deadline TEXT, location TEXT, fee REAL, max_participants INTEGER DEFAULT 100, registered_count INTEGER DEFAULT 0, format TEXT, score_range TEXT, validity TEXT, education_type TEXT, status TEXT DEFAULT 'open', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS exam_registrations ( id INTEGER PRIMARY KEY AUTOINCREMENT, exam_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, education_type TEXT, student_type TEXT, register_date TEXT, exam_fee_paid INTEGER DEFAULT 0, score REAL, score_report_url TEXT, status TEXT DEFAULT 'registered', UNIQUE(exam_id, student_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS overseas_students ( student_id INTEGER PRIMARY KEY, student_name TEXT NOT NULL, student_type TEXT, education_type TEXT, country TEXT, region TEXT, home_institution TEXT, host_institution TEXT, program_name TEXT, program_id TEXT, start_date TEXT, expected_graduation_date TEXT, visa_status TEXT, visa_expiry_date TEXT, accommodation TEXT, emergency_contact TEXT, health_insurance TEXT, language_level TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS student_visas ( visa_id TEXT PRIMARY KEY, student_id INTEGER NOT NULL, visa_type TEXT, country TEXT, issue_date TEXT, expiry_date TEXT, application_status TEXT DEFAULT 'applied', application_date TEXT, approved_date TEXT, rejection_reason TEXT, documents TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS intercultural_programs ( program_id TEXT PRIMARY KEY, program_name TEXT NOT NULL, program_type TEXT, education_type TEXT, description TEXT, location TEXT, region TEXT, duration TEXT, start_date TEXT, end_date TEXT, max_participants INTEGER DEFAULT 20, enrolled_count INTEGER DEFAULT 0, fee REAL, language_requirement TEXT, eligibility TEXT, status TEXT DEFAULT 'open', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS program_participants ( id INTEGER PRIMARY KEY AUTOINCREMENT, program_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, education_type TEXT, student_type TEXT, enroll_date TEXT, completion_status TEXT DEFAULT 'participating', completion_date TEXT, evaluation TEXT, UNIQUE(program_id, student_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS international_certifications ( cert_id TEXT PRIMARY KEY, cert_type TEXT NOT NULL, cert_name TEXT, education_type TEXT, grade_level INTEGER, issuing_body TEXT, valid_from TEXT, valid_until TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS certification_records ( record_id TEXT PRIMARY KEY, student_id INTEGER NOT NULL, cert_id TEXT NOT NULL, cert_type TEXT, education_type TEXT, exam_date TEXT, result TEXT, score REAL, certificate_no TEXT, certificate_url TEXT, issued_date TEXT, valid_until TEXT, status TEXT DEFAULT 'completed', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS study_abroad ( application_id TEXT PRIMARY KEY, student_id INTEGER NOT NULL, student_name TEXT, education_type TEXT, student_type TEXT, target_region TEXT, target_country TEXT, target_institution TEXT, target_program TEXT, application_status TEXT DEFAULT 'planning', test_scores TEXT, transcripts TEXT, letters_of_recommendation TEXT, personal_statement TEXT, application_date TEXT, acceptance_date TEXT, rejection_date TEXT, visa_status TEXT, departure_date TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS partner_institutions ( partner_id TEXT PRIMARY KEY, institution_name TEXT NOT NULL, country TEXT, region TEXT, institution_type TEXT, accreditation TEXT, partnership_type TEXT, contact_person TEXT, contact_email TEXT, contact_phone TEXT, website TEXT, description TEXT, status TEXT DEFAULT 'active', established_date TEXT, created_at TEXT, updated_at TEXT ) ''')
                conn.commit()
    ...
    def create_international_program(self, program_name: str, program_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO international_programs ( program_id, program_name, program_type, education_type, description, partner_institution, partner_id, duration, start_date, end_date, max_students, enrolled_count, tuition_fee, language_requirement, application_deadline, eligibility, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, ?, ?, ?, 'open', ?, ?) ''', (program_id, program_name, program_type,
    ...
    def add_partner_institution(self, institution_name: str, country: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO partner_institutions ( partner_id, institution_name, country, region, institution_type, accreditation, partnership_type, contact_person, contact_email, contact_phone, website, description, status, established_date, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?, ?) ''', (partner_id, institution_name, country,
    ...
    def create_international_course(self, course_name: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO international_courses ( course_id, course_name, course_code, program_id, education_type, grade_level, language, credits, instructor, instructor_id, semester, weekly_hours, max_students, enrolled_count, description, is_credit_recognized, partner_institution, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, ?, ?, 'active', ?, ?) ''', (course_id, course_name, kwargs.get('course_code'),
    ...
    def submit_exchange_application(self, student_id: int, program_id: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO exchange_applications ( application_id, student_id, program_id, exchange_type, host_institution, personal_statement, recommendation_letter, academic_transcript, language_proof, application_status, submitted_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'submitted', ?) ''', (application_id, student_id, program_id, exchange_type,
                ...
                with self._get_connection() as conn:
                    ...
                    if cursor.rowcount > 0:
                        if approved:
                            ...
                            cursor.execute(''' INSERT INTO exchange_students ( exchange_id, student_id, student_name, student_type, education_type, home_institution, host_institution, program_id, exchange_type, application_date, status ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'accepted') ''', (exchange_id, app[0], kwargs.get('student_name'),
    ...
    def register_overseas_student(self, student_id: int, student_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT OR REPLACE INTO overseas_students ( student_id, student_name, student_type, education_type, country, region, home_institution, host_institution, program_name, program_id, start_date, expected_graduation_date, visa_status, visa_expiry_date, accommodation, emergency_contact, health_insurance, language_level, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?) ''', (student_id, student_name, student_type,
    ...
    def apply_student_visa(self, student_id: int, visa_type: str, country: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO student_visas ( visa_id, student_id, visa_type, country, issue_date, expiry_date, application_status, application_date, documents ) VALUES (?, ?, ?, ?, ?, ?, 'applied', ?, ?) ''', (visa_id, student_id, visa_type, country,
                          kwargs.get('issue_date'), kwargs.get('expiry_date'),
                          now[:10], kwargs.get('documents')))
                    cursor.execute('UPDATE overseas_students SET visa_status = ? WHERE student_id = ?', ('applied',
                    student_id))
                    conn.commit()
    ...
    def create_international_exam(self, exam_type: str, exam_date: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO international_exams ( exam_id, exam_type, exam_name, exam_date, registration_deadline, location, fee, max_participants, registered_count, format, score_range, validity, education_type, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 0, ?, ?, ?, ?, 'open', ?, ?) ''', (exam_id, exam_type, kwargs.get('exam_name', config.get('name')),
    ...
    def create_study_abroad_application(self, student_id: int, student_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO study_abroad ( application_id, student_id, student_name, education_type, student_type, target_region, target_country, target_institution, target_program, application_status, test_scores, transcripts, letters_of_recommendation, personal_statement, application_date, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'planning', ?, ?, ?, ?, ?, ?, ?) ''', (application_id, student_id, student_name,
    ...
    def create_intercultural_program(self, program_name: str, program_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO intercultural_programs ( program_id, program_name, program_type, education_type, description, location, region, duration, start_date, end_date, max_participants, enrolled_count, fee, language_requirement, eligibility, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, ?, ?, 'open', ?, ?) ''', (program_id, program_name, program_type,
                          kwargs.get('education_type'), kwargs.get('description'),
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute('UPDATE program_participants SET completion_status = ?, completion_date = ?, evaluation = ? WHERE program_id = ? AND student_id = ? AND completion_status = ?',
                                 ('completed', now[:10], kwargs.get('evaluation'), program_id, student_id,
                                 'participating'))
                    if cursor.rowcount > 0:
                        conn.commit()
                        return {'success': True}
    ...
    def create_international_certification(self, cert_type: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO international_certifications ( cert_id, cert_type, cert_name, education_type, grade_level, issuing_body, valid_from, valid_until, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?) ''', (cert_id, cert_type, kwargs.get('cert_name', config.get('name')),
    ...
    def record_certification_result(self, student_id: int, cert_id: str, cert_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO certification_records ( record_id, student_id, cert_id, cert_type, education_type, exam_date, result, score, certificate_no, certificate_url, issued_date, valid_until, status ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (record_id, student_id, cert_id, cert_type,
    ...
    def verify_certification(self, certificate_no: str) -> Dict[str, Any]:
        try:
            with self._get_connection() as conn:
                conn.row_factory = sqlite3.Row
                cursor = conn.cursor()
                cursor.execute('SELECT * FROM certification_records WHERE certificate_no = ? AND result = ?',
                (certificate_no, 'pass'))
    ...
    def get_internationalization_stats(self, education_type: str = None) -> Dict[str, Any]:
        try:
            with self._get_connection() as conn:
                ...
                stats = {}
                if education_type:
                    cursor.execute('SELECT COUNT(*) FROM international_programs WHERE education_type = ?',
                    (education_type,))
                    ...
                    cursor.execute('SELECT COUNT(*) FROM intercultural_programs WHERE education_type = ?',
                    (education_type,))
