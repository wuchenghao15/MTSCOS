    ...
    def _init_db(self):
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute(''' CREATE TABLE IF NOT EXISTS student_insurance ( policy_id TEXT PRIMARY KEY, student_id INTEGER NOT NULL, student_name TEXT, insurance_type TEXT NOT NULL, education_type TEXT, grade_level INTEGER, coverage REAL, premium REAL, start_date TEXT, end_date TEXT, status TEXT DEFAULT 'active', policy_no TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS student_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, policy_id TEXT NOT NULL, student_id INTEGER, claim_type TEXT, claim_amount REAL, claim_date TEXT, status TEXT DEFAULT 'pending', description TEXT, processed_by TEXT, processed_at TEXT, FOREIGN KEY (policy_id) REFERENCES student_insurance(policy_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS teacher_insurance ( policy_id TEXT PRIMARY KEY, teacher_id INTEGER NOT NULL, teacher_name TEXT, insurance_type TEXT NOT NULL, education_type TEXT, coverage REAL, premium REAL, start_date TEXT, end_date TEXT, status TEXT DEFAULT 'active', policy_no TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS teacher_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, policy_id TEXT NOT NULL, teacher_id INTEGER, claim_type TEXT, claim_amount REAL, claim_date TEXT, status TEXT DEFAULT 'pending', description TEXT, processed_by TEXT, processed_at TEXT, FOREIGN KEY (policy_id) REFERENCES teacher_insurance(policy_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS school_insurance ( policy_id TEXT PRIMARY KEY, school_id INTEGER NOT NULL, school_name TEXT, insurance_type TEXT NOT NULL, coverage REAL, premium REAL, start_date TEXT, end_date TEXT, status TEXT DEFAULT 'active', policy_no TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS school_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, policy_id TEXT NOT NULL, school_id INTEGER, claim_type TEXT, claim_amount REAL, claim_date TEXT, status TEXT DEFAULT 'pending', description TEXT, processed_by TEXT, processed_at TEXT, FOREIGN KEY (policy_id) REFERENCES school_insurance(policy_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS education_fund ( fund_id TEXT PRIMARY KEY, student_id INTEGER NOT NULL, student_name TEXT, fund_type TEXT NOT NULL, education_type TEXT, grade_level INTEGER, total_amount REAL, paid_amount REAL, annual_premium REAL, start_date TEXT, maturity_date TEXT, expected_return REAL, status TEXT DEFAULT 'active', fund_no TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS fund_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, fund_id TEXT NOT NULL, student_id INTEGER, transaction_type TEXT, transaction_amount REAL, transaction_date TEXT, balance REAL, description TEXT, FOREIGN KEY (fund_id) REFERENCES education_fund(fund_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS health_insurance ( policy_id TEXT PRIMARY KEY, user_id INTEGER NOT NULL, user_name TEXT, insurance_type TEXT NOT NULL, education_type TEXT, coverage REAL, premium REAL, start_date TEXT, end_date TEXT, status TEXT DEFAULT 'active', policy_no TEXT, preexisting_conditions TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS health_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, policy_id TEXT NOT NULL, user_id INTEGER, claim_type TEXT, claim_amount REAL, claim_date TEXT, status TEXT DEFAULT 'pending', diagnosis TEXT, hospital TEXT, processed_by TEXT, processed_at TEXT, FOREIGN KEY (policy_id) REFERENCES health_insurance(policy_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS accident_insurance ( policy_id TEXT PRIMARY KEY, user_id INTEGER NOT NULL, user_name TEXT, insurance_type TEXT NOT NULL, education_type TEXT, coverage REAL, premium REAL, start_date TEXT, end_date TEXT, status TEXT DEFAULT 'active', policy_no TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS accident_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, policy_id TEXT NOT NULL, user_id INTEGER, accident_type TEXT, claim_amount REAL, accident_date TEXT, status TEXT DEFAULT 'pending', description TEXT, location TEXT, processed_by TEXT, processed_at TEXT, FOREIGN KEY (policy_id) REFERENCES accident_insurance(policy_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS property_insurance ( policy_id TEXT PRIMARY KEY, owner_id INTEGER NOT NULL, owner_name TEXT, insurance_type TEXT NOT NULL, property_name TEXT, property_value REAL, coverage REAL, premium REAL, start_date TEXT, end_date TEXT, status TEXT DEFAULT 'active', policy_no TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS property_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, policy_id TEXT NOT NULL, owner_id INTEGER, loss_type TEXT, claim_amount REAL, loss_date TEXT, status TEXT DEFAULT 'pending', description TEXT, assessed_value REAL, processed_by TEXT, processed_at TEXT, FOREIGN KEY (policy_id) REFERENCES property_insurance(policy_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS liability_insurance ( policy_id TEXT PRIMARY KEY, entity_id INTEGER NOT NULL, entity_name TEXT, insurance_type TEXT NOT NULL, coverage REAL, premium REAL, start_date TEXT, end_date TEXT, status TEXT DEFAULT 'active', policy_no TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS liability_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, policy_id TEXT NOT NULL, entity_id INTEGER, claim_type TEXT, claim_amount REAL, claim_date TEXT, status TEXT DEFAULT 'pending', description TEXT, third_party TEXT, processed_by TEXT, processed_at TEXT, FOREIGN KEY (policy_id) REFERENCES liability_insurance(policy_id) ) ''')
                conn.commit()
    ...
    def enroll_student_insurance(self, student_id: int, student_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO student_insurance ( policy_id, student_id, student_name, insurance_type, education_type, grade_level, coverage, premium, start_date, end_date, status, policy_no, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?, ?) ''', (policy_id, student_id, student_name, insurance_type,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT INTO student_records (policy_id, student_id, claim_type, claim_amount, claim_date, status, description) VALUES (?, ?, ?, ?, ?, 'pending', ?) ''', (policy_id, policy[0], claim_type, claim_amount, now[:10], kwargs.get('description')))
                    conn.commit()
    ...
    def enroll_teacher_insurance(self, teacher_id: int, teacher_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO teacher_insurance ( policy_id, teacher_id, teacher_name, insurance_type, education_type, coverage, premium, start_date, end_date, status, policy_no, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?, ?) ''', (policy_id, teacher_id, teacher_name, insurance_type,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    if claim_amount > policy[2]:
                        return {'success': False, 'error': '理赔金额超过保额'}
                    cursor.execute(''' INSERT INTO teacher_records (policy_id, teacher_id, claim_type, claim_amount, claim_date, status, description) VALUES (?, ?, ?, ?, ?, 'pending', ?) ''', (policy_id, policy[0], claim_type, claim_amount, now[:10], kwargs.get('description')))
                    conn.commit()
                    return {'success': True, 'claim_id': cursor.lastrowid}
        except Exception as e:
    ...
    def enroll_school_insurance(self, school_id: int, school_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO school_insurance ( policy_id, school_id, school_name, insurance_type, coverage, premium, start_date, end_date, status, policy_no, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?, ?) ''', (policy_id, school_id, school_name, insurance_type,
                          kwargs.get('coverage', config['coverage']),
                          kwargs.get('premium', config['premium']),
                          now[:10], end_date, policy_no, now, now))
                    conn.commit()
    ...
    def file_school_claim(self, policy_id: str, claim_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT school_id, school_name, coverage FROM school_insurance WHERE policy_id = ?',
                    (policy_id,))
                    policy = cursor.fetchone()
                    if not policy:
                        return {'success': False, 'error': '保单不存在'}
                    if claim_amount > policy[2]:
                        return {'success': False, 'error': '理赔金额超过保额'}
                    cursor.execute(''' INSERT INTO school_records (policy_id, school_id, claim_type, claim_amount, claim_date, status, description) VALUES (?, ?, ?, ?, ?, 'pending', ?) ''', (policy_id, policy[0], claim_type, claim_amount, now[:10], kwargs.get('description')))
                    conn.commit()
                    return {'success': True, 'claim_id': cursor.lastrowid}
        except Exception as e:
    ...
    def create_education_fund(self, student_id: int, student_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO education_fund ( fund_id, student_id, student_name, fund_type, education_type, grade_level, total_amount, paid_amount, annual_premium, start_date, maturity_date, expected_return, status, fund_no, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 0, ?, ?, ?, ?, 'active', ?, ?, ?) ''', (fund_id, student_id, student_name, fund_type,
                          education_type, kwargs.get('grade_level'),
    ...
    def add_fund_payment(self, fund_id: str, amount: float) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT paid_amount, total_amount, student_id FROM education_fund WHERE fund_id = ?',
                    (fund_id,))
                    ...
                    cursor.execute(''' INSERT INTO fund_records (fund_id, student_id, transaction_type, transaction_amount, transaction_date, balance, description) VALUES (?, ?, 'payment', ?, ?, ?, '缴纳保费') ''', (fund_id, fund[2], amount, now[:10], new_paid))
                    conn.commit()
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT INTO fund_records (fund_id, student_id, transaction_type, transaction_amount, transaction_date, balance, description) VALUES (?, ?, 'withdrawal', ?, ?, ?, '支取教育金') ''', (fund_id, 0, amount, now[:10], new_balance))
                    conn.commit()
    ...
    def list_fund_transactions(self, fund_id: str, page: int = 1,
        ...
        try:
            with self._get_connection() as conn:
                ...
                cursor.execute(
                'SELECT * FROM fund_records WHERE fund_id = ? ORDER BY transaction_date DESC LIMIT ? OFFSET ?',
    ...
    def enroll_health_insurance(self, user_id: int, user_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO health_insurance ( policy_id, user_id, user_name, insurance_type, education_type, coverage, premium, start_date, end_date, status, policy_no, preexisting_conditions, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?, ?, ?) ''', (policy_id, user_id, user_name, insurance_type,
                          education_type, kwargs.get('coverage', config['coverage']),
                          kwargs.get('premium', config['premium']),
    ...
    def file_health_claim(self, policy_id: str, claim_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT user_id, user_name, coverage FROM health_insurance WHERE policy_id = ?',
                    (policy_id,))
                    policy = cursor.fetchone()
                    if not policy:
                        return {'success': False, 'error': '保单不存在'}
                    if claim_amount > policy[2]:
                        return {'success': False, 'error': '理赔金额超过保额'}
                    cursor.execute(''' INSERT INTO health_records (policy_id, user_id, claim_type, claim_amount, claim_date, status, diagnosis, hospital) VALUES (?, ?, ?, ?, ?, 'pending', ?, ?) ''', (policy_id, policy[0], claim_type, claim_amount, now[:10],
    ...
    def enroll_accident_insurance(self, user_id: int, user_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO accident_insurance ( policy_id, user_id, user_name, insurance_type, education_type, coverage, premium, start_date, end_date, status, policy_no, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?, ?) ''', (policy_id, user_id, user_name, insurance_type,
                          education_type, kwargs.get('coverage', config['coverage']),
                          kwargs.get('premium', config['premium']),
                          now[:10], end_date, policy_no, now, now))
                    conn.commit()
    ...
    def file_accident_claim(self, policy_id: str, accident_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT user_id, user_name, coverage FROM accident_insurance WHERE policy_id = ?',
                    (policy_id,))
                    policy = cursor.fetchone()
                    if not policy:
                        return {'success': False, 'error': '保单不存在'}
                    if claim_amount > policy[2]:
                        return {'success': False, 'error': '理赔金额超过保额'}
                    cursor.execute(''' INSERT INTO accident_records (policy_id, user_id, accident_type, claim_amount, accident_date, status, description, location) VALUES (?, ?, ?, ?, ?, 'pending', ?, ?) ''', (policy_id, policy[0], accident_type, claim_amount, now[:10],
    ...
    def enroll_property_insurance(self, owner_id: int, owner_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO property_insurance ( policy_id, owner_id, owner_name, insurance_type, property_name, property_value, coverage, premium, start_date, end_date, status, policy_no, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?, ?) ''', (policy_id, owner_id, owner_name, insurance_type,
    ...
    def file_property_claim(self, policy_id: str, loss_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT owner_id, owner_name, coverage FROM property_insurance WHERE policy_id = ?',
                    (policy_id,))
                    policy = cursor.fetchone()
                    if not policy:
                        return {'success': False, 'error': '保单不存在'}
                    if claim_amount > policy[2]:
                        return {'success': False, 'error': '理赔金额超过保额'}
                    cursor.execute(''' INSERT INTO property_records (policy_id, owner_id, loss_type, claim_amount, loss_date, status, description, assessed_value) VALUES (?, ?, ?, ?, ?, 'pending', ?, ?) ''', (policy_id, policy[0], loss_type, claim_amount, now[:10],
    ...
    def enroll_liability_insurance(self, entity_id: int, entity_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO liability_insurance ( policy_id, entity_id, entity_name, insurance_type, coverage, premium, start_date, end_date, status, policy_no, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?, ?) ''', (policy_id, entity_id, entity_name, insurance_type,
                          kwargs.get('coverage', config['coverage']),
                          kwargs.get('premium', config['premium']),
                          now[:10], end_date, policy_no, now, now))
                    conn.commit()
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    if claim_amount > policy[2]:
                        return {'success': False, 'error': '理赔金额超过保额'}
                    cursor.execute(''' INSERT INTO liability_records (policy_id, entity_id, claim_type, claim_amount, claim_date, status, description, third_party) VALUES (?, ?, ?, ?, ?, 'pending', ?, ?) ''', (policy_id, policy[0], claim_type, claim_amount, now[:10],
