...
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
""" MTSCOS 教育安全保障服务 (v15.26.0) ==================================== 提供校园安全、网络安全、食品安全、消防安全、交通安全、应急管理、安全培训和安全评估等综合管理服务。  核心能力： 1. 校园安全管理 - 门禁管理、巡逻管理、监控管理、访客管理、安保人员、安全设施、安全事件、安全预警 2. 网络安全管理 - 防火墙、入侵检测、病毒防护、数据加密、访问控制、安全审计、网络监控、漏洞管理 3. 食品安全管理 - 食材采购、食品加工、食品储存、卫生检查、从业人员、食品留样、营养配餐、食品安全事件 4. 消防安全管理 - 消防设施、消防检查、消防演练、火灾隐患、消防培训、消防安全档案、消防预案、火灾事故 5. 交通安全管理 - 车辆管理、停车管理、交通设施、交通安全宣传、交通事故、交通应急预案、校车管理、步行安全 6. 应急管理 - 应急预案、应急演练、应急物资、应急队伍、应急响应、应急指挥、应急评估、应急改进 7. 安全培训 - 安全教育、安全演练、安全讲座、安全手册、安全考核、安全证书、安全宣传、安全咨询 8. 安全评估 - 风险评估、安全检查、隐患排查、安全等级、安全报告、安全整改、安全复查、安全统计  差异化支持：成人教育 / K12教育 """
import os
import json
import uuid
import sqlite3
        ...
        try:
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' CREATE TABLE IF NOT EXISTS campus_security ( security_id TEXT PRIMARY KEY, security_type TEXT NOT NULL, name TEXT NOT NULL, education_type TEXT, location TEXT, description TEXT, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS security_records ( record_id TEXT PRIMARY KEY, security_id TEXT NOT NULL, record_type TEXT NOT NULL, content TEXT, operator TEXT, operator_id INTEGER, record_time TEXT, education_type TEXT, FOREIGN KEY (security_id) REFERENCES campus_security(security_id) ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS network_security ( security_id TEXT PRIMARY KEY, security_type TEXT NOT NULL, name TEXT NOT NULL, education_type TEXT, device_name TEXT, ip_address TEXT, status TEXT DEFAULT 'active', last_scan TEXT, created_at TEXT, updated_at TEXT ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS network_records ( record_id TEXT PRIMARY KEY, security_id TEXT NOT NULL, record_type TEXT NOT NULL, content TEXT, severity TEXT, operator TEXT, record_time TEXT, education_type TEXT, FOREIGN KEY (security_id) REFERENCES network_security(security_id) ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS food_security ( security_id TEXT PRIMARY KEY, security_type TEXT NOT NULL, name TEXT NOT NULL, education_type TEXT, supplier TEXT, location TEXT, status TEXT DEFAULT 'active', last_inspection TEXT, created_at TEXT, updated_at TEXT ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS food_records ( record_id TEXT PRIMARY KEY, security_id TEXT NOT NULL, record_type TEXT NOT NULL, content TEXT, inspector TEXT, result TEXT, record_time TEXT, education_type TEXT, FOREIGN KEY (security_id) REFERENCES food_security(security_id) ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS fire_security ( security_id TEXT PRIMARY KEY, security_type TEXT NOT NULL, name TEXT NOT NULL, education_type TEXT, location TEXT, equipment_type TEXT, status TEXT DEFAULT 'active', last_check TEXT, next_check TEXT, created_at TEXT, updated_at TEXT ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS fire_records ( record_id TEXT PRIMARY KEY, security_id TEXT NOT NULL, record_type TEXT NOT NULL, content TEXT, operator TEXT, result TEXT, record_time TEXT, education_type TEXT, FOREIGN KEY (security_id) REFERENCES fire_security(security_id) ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS traffic_security ( security_id TEXT PRIMARY KEY, security_type TEXT NOT NULL, name TEXT NOT NULL, education_type TEXT, location TEXT, vehicle_type TEXT, status TEXT DEFAULT 'active', last_audit TEXT, created_at TEXT, updated_at TEXT ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS traffic_records ( record_id TEXT PRIMARY KEY, security_id TEXT NOT NULL, record_type TEXT NOT NULL, content TEXT, operator TEXT, result TEXT, record_time TEXT, education_type TEXT, FOREIGN KEY (security_id) REFERENCES traffic_security(security_id) ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS emergency_management ( emergency_id TEXT PRIMARY KEY, emergency_type TEXT NOT NULL, name TEXT NOT NULL, education_type TEXT, description TEXT, scope TEXT, status TEXT DEFAULT 'draft', created_at TEXT, updated_at TEXT ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS emergency_records ( record_id TEXT PRIMARY KEY, emergency_id TEXT NOT NULL, record_type TEXT NOT NULL, content TEXT, operator TEXT, result TEXT, record_time TEXT, education_type TEXT, FOREIGN KEY (emergency_id) REFERENCES emergency_management(emergency_id) ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS safety_training ( training_id TEXT PRIMARY KEY, training_type TEXT NOT NULL, name TEXT NOT NULL, education_type TEXT, description TEXT, target_audience TEXT, status TEXT DEFAULT 'planned', start_date TEXT, end_date TEXT, created_at TEXT, updated_at TEXT ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS training_records ( record_id TEXT PRIMARY KEY, training_id TEXT NOT NULL, record_type TEXT NOT NULL, content TEXT, participant_id INTEGER, participant_name TEXT, result TEXT, record_time TEXT, education_type TEXT, FOREIGN KEY (training_id) REFERENCES safety_training(training_id) ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS security_assessment ( assessment_id TEXT PRIMARY KEY, assessment_type TEXT NOT NULL, name TEXT NOT NULL, education_type TEXT, description TEXT, scope TEXT, status TEXT DEFAULT 'in_progress', start_date TEXT, end_date TEXT, created_at TEXT, updated_at TEXT ) ''')

                    cursor.execute(''' CREATE TABLE IF NOT EXISTS assessment_records ( record_id TEXT PRIMARY KEY, assessment_id TEXT NOT NULL, record_type TEXT NOT NULL, content TEXT, assessor TEXT, result TEXT, score REAL, record_time TEXT, education_type TEXT, FOREIGN KEY (assessment_id) REFERENCES security_assessment(assessment_id) ) ''')
    ...
    def create_campus_security(self, security_type: str, name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO campus_security ( security_id, security_type, name, education_type, location, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, 'active', ?, ?) ''', (security_id, security_type, name, education_type,
    ...
    def record_security_event(self, security_id: str, record_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO security_records ( record_id, security_id, record_type, content, operator, operator_id, record_time, education_type ) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ''', (record_id, security_id, record_type, content,
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    if update_fields:
                        ...
                        cursor.execute(f'UPDATE campus_security SET {", ".join(update_fields)} WHERE security_id = ?',
                        params)
    ...
    def create_network_security(self, security_type: str, name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO network_security ( security_id, security_type, name, education_type, device_name, ip_address, status, last_scan, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, 'active', NULL, ?, ?) ''', (security_id, security_type, name, education_type,
    ...
    def record_network_event(self, security_id: str, record_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO network_records ( record_id, security_id, record_type, content, severity, operator, record_time, education_type ) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ''', (record_id, security_id, record_type, content,
                          kwargs.get('severity', 'medium'), kwargs.get('operator'),
                          now, kwargs.get('education_type')))
                    if kwargs.get('severity') == 'critical':
                        cursor.execute('UPDATE network_security SET status = ?, updated_at = ? WHERE security_id = ?',
                        ('warning', now, security_id))
                    conn.commit()
                    return {'success': True, 'record_id': record_id}
        except Exception as e:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    if update_fields:
                        ...
                        params.append(now)
                        params.append(security_id)
                        cursor.execute(f'UPDATE network_security SET {", ".join(update_fields)} WHERE security_id = ?',
                        params)
                        if cursor.rowcount > 0:
                            conn.commit()
                            return {'success': True}
    ...
    def create_food_security(self, security_type: str, name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO food_security ( security_id, security_type, name, education_type, supplier, location, status, last_inspection, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, 'active', NULL, ?, ?) ''', (security_id, security_type, name, education_type,
    ...
    def record_food_inspection(self, security_id: str, record_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO food_records ( record_id, security_id, record_type, content, inspector, result, record_time, education_type ) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ''', (record_id, security_id, record_type, content,
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    if update_fields:
                        ...
                        params.append(now)
                        params.append(security_id)
                        cursor.execute(f'UPDATE food_security SET {", ".join(update_fields)} WHERE security_id = ?',
                        params)
                        if cursor.rowcount > 0:
                            conn.commit()
                            return {'success': True}
    ...
    def create_fire_security(self, security_type: str, name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO fire_security ( security_id, security_type, name, education_type, location, equipment_type, status, last_check, next_check, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, 'active', NULL, ?, ?, ?) ''', (security_id, security_type, name, education_type,
    ...
    def record_fire_check(self, security_id: str, record_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO fire_records ( record_id, security_id, record_type, content, operator, result, record_time, education_type ) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ''', (record_id, security_id, record_type, content,
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    if update_fields:
                        ...
                        params.append(now)
                        params.append(security_id)
                        cursor.execute(f'UPDATE fire_security SET {", ".join(update_fields)} WHERE security_id = ?',
                        params)
                        if cursor.rowcount > 0:
                            conn.commit()
                            return {'success': True}
    ...
    def schedule_fire_drill(self, education_type: str, drill_date: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO fire_records ( record_id, security_id, record_type, content, operator, result, record_time, education_type ) VALUES (?, 'drill_scheduled', 'drill', ?, ?, 'scheduled', ?, ?) ''', (drill_id, kwargs.get('description', f'{education_type}消防演练计划于{drill_date}'),
    ...
    def create_traffic_security(self, security_type: str, name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO traffic_security ( security_id, security_type, name, education_type, location, vehicle_type, status, last_audit, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, 'active', NULL, ?, ?) ''', (security_id, security_type, name, education_type,
    ...
    def record_traffic_event(self, security_id: str, record_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO traffic_records ( record_id, security_id, record_type, content, operator, result, record_time, education_type ) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ''', (record_id, security_id, record_type, content,
                          kwargs.get('operator'), kwargs.get('result'),
                          now, kwargs.get('education_type')))
                    if record_type == 'accident':
                        cursor.execute('UPDATE traffic_security SET status = ?, updated_at = ? WHERE security_id = ?',
                        ('incident', now, security_id))
                    conn.commit()
                    return {'success': True, 'record_id': record_id}
        except Exception as e:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    if update_fields:
                        ...
                        params.append(now)
                        params.append(security_id)
                        cursor.execute(f'UPDATE traffic_security SET {", ".join(update_fields)} WHERE security_id = ?',
                        params)
                        if cursor.rowcount > 0:
                            conn.commit()
                            return {'success': True}
    ...
    def create_emergency_plan(self, emergency_type: str, name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO emergency_management ( emergency_id, emergency_type, name, education_type, description, scope, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, 'draft', ?, ?) ''', (emergency_id, emergency_type, name, education_type,
    ...
    def record_emergency_event(self, emergency_id: str, record_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO emergency_records ( record_id, emergency_id, record_type, content, operator, result, record_time, education_type ) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ''', (record_id, emergency_id, record_type, content,
                          kwargs.get('operator'), kwargs.get('result'),
                          now, kwargs.get('education_type')))
    ...
    def create_safety_training(self, training_type: str, name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO safety_training ( training_id, training_type, name, education_type, description, target_audience, status, start_date, end_date, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, 'planned', ?, ?, ?, ?) ''', (training_id, training_type, name, education_type,
    ...
    def record_training_participation(self, training_id: str, participant_id: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO training_records ( record_id, training_id, record_type, content, participant_id, participant_name, result, record_time, education_type ) VALUES (?, ?, 'participation', ?, ?, ?, ?, ?, ?) ''', (record_id, training_id, kwargs.get('content', '参训'),
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    if update_fields:
                        ...
                        cursor.execute(f'UPDATE safety_training SET {", ".join(update_fields)} WHERE training_id = ?',
                        params)
                        if cursor.rowcount > 0:
                            conn.commit()
                            return {'success': True}
    ...
    def create_security_assessment(self, assessment_type: str, name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO security_assessment ( assessment_id, assessment_type, name, education_type, description, scope, status, start_date, end_date, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, 'in_progress', ?, ?, ?, ?) ''', (assessment_id, assessment_type, name, education_type,
    ...
    def record_assessment_result(self, assessment_id: str, record_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO assessment_records ( record_id, assessment_id, record_type, content, assessor, result, score, record_time, education_type ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (record_id, assessment_id, record_type, content,
    ...
    def get_security_statistics(self, education_type: str = None,
        ...
        try:
            with self._get_connection() as conn:
                ...
                cursor.execute(f'SELECT COUNT(*) as cnt FROM fire_records WHERE record_type = "accident"{date_filter}',
                event_params)
