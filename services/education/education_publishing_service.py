    ...
    def _init_db(self):
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute(''' CREATE TABLE IF NOT EXISTS textbook_publishing ( textbook_id TEXT PRIMARY KEY, textbook_name TEXT NOT NULL, textbook_type TEXT NOT NULL, education_type TEXT NOT NULL, grade_level TEXT, subject TEXT, author TEXT, editor TEXT, publisher TEXT, isbn TEXT, pages INTEGER, format TEXT, price REAL, cost REAL, status TEXT DEFAULT 'planning', publish_date TEXT, description TEXT, cover_image TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS publishing_records ( record_id INTEGER PRIMARY KEY AUTOINCREMENT, textbook_id TEXT NOT NULL, stage TEXT NOT NULL, stage_name TEXT, responsible_person TEXT, start_date TEXT, end_date TEXT, status TEXT DEFAULT 'in_progress', notes TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS digital_publishing ( digital_id TEXT PRIMARY KEY, digital_name TEXT NOT NULL, digital_type TEXT NOT NULL, education_type TEXT NOT NULL, textbook_id TEXT, author TEXT, editor TEXT, publisher TEXT, isbn TEXT, file_format TEXT, file_size REAL, price REAL, cost REAL, status TEXT DEFAULT 'processing', publish_date TEXT, download_url TEXT, preview_url TEXT, description TEXT, cover_image TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS digital_records ( record_id INTEGER PRIMARY KEY AUTOINCREMENT, digital_id TEXT NOT NULL, stage TEXT NOT NULL, stage_name TEXT, responsible_person TEXT, start_date TEXT, end_date TEXT, status TEXT DEFAULT 'in_progress', notes TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS copyright_management ( copyright_id TEXT PRIMARY KEY, textbook_id TEXT, digital_id TEXT, copyright_type TEXT NOT NULL, owner TEXT, author TEXT, registration_no TEXT, registration_date TEXT, protection_start TEXT, protection_end TEXT, status TEXT DEFAULT 'active', description TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS copyright_records ( record_id INTEGER PRIMARY KEY AUTOINCREMENT, copyright_id TEXT NOT NULL, action TEXT NOT NULL, action_name TEXT, party TEXT, amount REAL, effective_date TEXT, expiration_date TEXT, contract_no TEXT, status TEXT DEFAULT 'pending', notes TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS publishing_distribution ( distribution_id TEXT PRIMARY KEY, textbook_id TEXT, digital_id TEXT, channel TEXT NOT NULL, channel_name TEXT, education_type TEXT NOT NULL, price REAL, quantity INTEGER DEFAULT 0, stock INTEGER DEFAULT 0, sold INTEGER DEFAULT 0, status TEXT DEFAULT 'active', start_date TEXT, end_date TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS distribution_records ( record_id INTEGER PRIMARY KEY AUTOINCREMENT, distribution_id TEXT NOT NULL, action TEXT NOT NULL, action_name TEXT, quantity INTEGER, unit_price REAL, total_amount REAL, customer TEXT, address TEXT, tracking_no TEXT, status TEXT DEFAULT 'pending', notes TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS publishing_marketing ( marketing_id TEXT PRIMARY KEY, textbook_id TEXT, digital_id TEXT, marketing_method TEXT NOT NULL, method_name TEXT, education_type TEXT NOT NULL, budget REAL DEFAULT 0, spent REAL DEFAULT 0, target_audience TEXT, campaign_name TEXT, status TEXT DEFAULT 'planning', start_date TEXT, end_date TEXT, description TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS marketing_records ( record_id INTEGER PRIMARY KEY AUTOINCREMENT, marketing_id TEXT NOT NULL, action TEXT NOT NULL, action_name TEXT, channel TEXT, cost REAL, impressions INTEGER DEFAULT 0, clicks INTEGER DEFAULT 0, conversions INTEGER DEFAULT 0, notes TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS publishing_analysis ( analysis_id TEXT PRIMARY KEY, textbook_id TEXT, digital_id TEXT, education_type TEXT NOT NULL, analysis_type TEXT NOT NULL, analysis_name TEXT, period TEXT, data_source TEXT, status TEXT DEFAULT 'processing', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS analysis_data ( data_id INTEGER PRIMARY KEY AUTOINCREMENT, analysis_id TEXT NOT NULL, dimension TEXT, metric TEXT, value REAL, value_text TEXT, period TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS publishing_cooperation ( cooperation_id TEXT PRIMARY KEY, cooperation_type TEXT NOT NULL, type_name TEXT, education_type TEXT NOT NULL, partner_name TEXT, partner_contact TEXT, cooperation_model TEXT, amount REAL, status TEXT DEFAULT 'negotiating', start_date TEXT, end_date TEXT, description TEXT, contract_no TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS cooperation_records ( record_id INTEGER PRIMARY KEY AUTOINCREMENT, cooperation_id TEXT NOT NULL, action TEXT NOT NULL, action_name TEXT, responsible_person TEXT, date TEXT, outcome TEXT, notes TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS publishing_quality ( quality_id TEXT PRIMARY KEY, textbook_id TEXT, digital_id TEXT, education_type TEXT NOT NULL, control_type TEXT NOT NULL, control_name TEXT, inspector TEXT, status TEXT DEFAULT 'pending', score REAL, pass_threshold REAL DEFAULT 80, is_pass INTEGER DEFAULT 0, notes TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS quality_records ( record_id INTEGER PRIMARY KEY AUTOINCREMENT, quality_id TEXT NOT NULL, check_item TEXT, check_result TEXT, is_pass INTEGER, notes TEXT, created_at TEXT ) ''')
                conn.commit()
    ...
    def create_textbook(self, textbook_name: str, textbook_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO textbook_publishing ( textbook_id, textbook_name, textbook_type, education_type, grade_level, subject, author, editor, publisher, isbn, pages, format, price, cost, status, publish_date, description, cover_image, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'planning', ?, ?, ?, ?, ?) ''', (textbook_id, textbook_name, textbook_type, education_type,
    ...
    def update_textbook_stage(self, textbook_id: str, stage: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO publishing_records ( textbook_id, stage, stage_name, responsible_person, start_date, end_date, status, notes, created_at ) VALUES (?, ?, ?, ?, ?, ?, 'in_progress', ?, ?) ''', (textbook_id, stage, stages.get(stage, stage),
    ...
    def create_digital_publishing(self, digital_name: str, digital_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO digital_publishing ( digital_id, digital_name, digital_type, education_type, textbook_id, author, editor, publisher, isbn, file_format, file_size, price, cost, status, publish_date, download_url, preview_url, description, cover_image, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'processing', ?, ?, ?, ?, ?, ?, ?) ''', (digital_id, digital_name, digital_type, education_type,
    ...
    def update_digital_stage(self, digital_id: str, stage: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO digital_records ( digital_id, stage, stage_name, responsible_person, start_date, end_date, status, notes, created_at ) VALUES (?, ?, ?, ?, ?, ?, 'in_progress', ?, ?) ''', (digital_id, stage, stages.get(stage, stage),
                          kwargs.get('responsible_person'), now[:10],
                          kwargs.get('end_date'), kwargs.get('notes'), now))
    ...
    def register_copyright(self, copyright_type: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO copyright_management ( copyright_id, textbook_id, digital_id, copyright_type, owner, author, registration_no, registration_date, protection_start, protection_end, status, description, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', ?, ?, ?) ''', (copyright_id, kwargs.get('textbook_id'), kwargs.get('digital_id'),
    ...
    def license_copyright(self, copyright_id: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO copyright_records ( copyright_id, action, action_name, party, amount, effective_date, expiration_date, contract_no, status, notes, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?, ?) ''', (copyright_id, 'license', actions['license'],
    ...
    def transfer_copyright(self, copyright_id: str, **kwargs) -> Dict[str, Any]:
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO copyright_records ( copyright_id, action, action_name, party, amount, effective_date, expiration_date, contract_no, status, notes, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?, ?) ''', (copyright_id, 'transfer', actions['transfer'],
                          kwargs.get('party'), kwargs.get('amount', 0),
                          now[:10], kwargs.get('expiration_date'),
                          kwargs.get('contract_no'), kwargs.get('notes'), now))
    ...
    def create_distribution(self, channel: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO publishing_distribution ( distribution_id, textbook_id, digital_id, channel, channel_name, education_type, price, quantity, stock, sold, status, start_date, end_date, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 0, 'active', ?, ?, ?, ?) ''', (distribution_id, kwargs.get('textbook_id'), kwargs.get('digital_id'),
                ...
                with self._get_connection() as conn:
                    ...
                    if operation == 'add':
                        ...
                        cursor.execute('UPDATE publishing_distribution SET stock = ?, updated_at = ? WHERE distribution_id = ?',
                                     (quantity, now, distribution_id))
                    if cursor.rowcount > 0:
                        cursor.execute(''' INSERT INTO distribution_records ( distribution_id, action, action_name, quantity, status, notes, created_at ) VALUES (?, ?, ?, ?, 'completed', ?, ?) ''', (distribution_id, operation, '库存调整', quantity, f'{operation} {quantity}', now))
                        conn.commit()
                        return {'success': True}
    ...
    def record_sale(self, distribution_id: str, quantity: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT stock, price FROM publishing_distribution WHERE distribution_id = ?',
                    (distribution_id,))
                    ...
                    cursor.execute(''' INSERT INTO distribution_records ( distribution_id, action, action_name, quantity, unit_price, total_amount, customer, address, tracking_no, status, notes, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'completed', ?, ?) ''', (distribution_id, 'sale', '销售', quantity, unit_price,
    ...
    def list_distributions(self, education_type: str = None, channel: str = None,
        ...
        try:
            with self._get_connection() as conn:
                ...
                return {'success': True, 'distributions': distributions, 'total': total, 'page': page,
                'page_size': page_size}
        except Exception as e:
    ...
    def get_stock_summary(self, education_type: str = None) -> Dict[str, Any]:
        try:
            with self._get_connection() as conn:
                ...
                return {'success': True, 'total_stock': result[0] or 0, 'total_sold': result[1] or 0,
    ...
    def create_marketing_campaign(self, marketing_method: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO publishing_marketing ( marketing_id, textbook_id, digital_id, marketing_method, method_name, education_type, budget, spent, target_audience, campaign_name, status, start_date, end_date, description, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 0, ?, ?, 'planning', ?, ?, ?, ?, ?) ''', (marketing_id, kwargs.get('textbook_id'), kwargs.get('digital_id'),
    ...
    def execute_marketing_action(self, marketing_id: str, action: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO marketing_records ( marketing_id, action, action_name, channel, cost, impressions, clicks, conversions, notes, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (marketing_id, action, actions.get(action, action),
    ...
    def create_analysis(self, analysis_type: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO publishing_analysis ( analysis_id, textbook_id, digital_id, education_type, analysis_type, analysis_name, period, data_source, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'processing', ?, ?) ''', (analysis_id, kwargs.get('textbook_id'), kwargs.get('digital_id'),
    ...
    def add_analysis_data(self, analysis_id: str, dimension: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO analysis_data ( analysis_id, dimension, metric, value, value_text, period, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?) ''', (analysis_id, dimension, metric, value,
    ...
    def create_cooperation(self, cooperation_type: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO publishing_cooperation ( cooperation_id, cooperation_type, type_name, education_type, partner_name, partner_contact, cooperation_model, amount, status, start_date, end_date, description, contract_no, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'negotiating', ?, ?, ?, ?, ?, ?) ''', (cooperation_id, cooperation_type, config.get('name', cooperation_type),
    ...
    def update_cooperation_status(self, cooperation_id: str, status: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO cooperation_records ( cooperation_id, action, action_name, responsible_person, date, outcome, notes, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ''', (cooperation_id, 'status_update', statuses.get(status, status),
                          kwargs.get('responsible_person'), now[:10],
    ...
    def sign_cooperation_contract(self, cooperation_id: str, contract_no: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO cooperation_records ( cooperation_id, action, action_name, responsible_person, date, outcome, notes, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ''', (cooperation_id, 'sign', '签约', kwargs.get('responsible_person'),
    ...
    def create_quality_check(self, control_type: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO publishing_quality ( quality_id, textbook_id, digital_id, education_type, control_type, control_name, inspector, status, score, pass_threshold, is_pass, notes, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 'pending', 0, ?, 0, ?, ?, ?) ''', (quality_id, kwargs.get('textbook_id'), kwargs.get('digital_id'),
    ...
    def add_quality_check_item(self, quality_id: str, check_item: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO quality_records ( quality_id, check_item, check_result, is_pass, notes, created_at ) VALUES (?, ?, ?, ?, ?, ?) ''', (quality_id, check_item, check_result, 1 if is_pass else 0,
                          check_result, now))
                    conn.commit()
                    return {'success': True}
        except Exception as e:
