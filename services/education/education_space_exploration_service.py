    ...
    def _init_db(self):
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute(''' CREATE TABLE IF NOT EXISTS space_courses ( course_id TEXT PRIMARY KEY, course_name TEXT NOT NULL, course_type TEXT, education_type TEXT, grade_level INTEGER, subject TEXT, description TEXT, duration_hours REAL DEFAULT 40, credits INTEGER DEFAULT 3, teacher_id INTEGER, teacher_name TEXT, max_students INTEGER DEFAULT 30, enrolled_count INTEGER DEFAULT 0, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS course_modules ( module_id TEXT PRIMARY KEY, course_id TEXT NOT NULL, module_name TEXT NOT NULL, module_order INTEGER DEFAULT 1, duration_hours REAL DEFAULT 4, content TEXT, resources TEXT, status TEXT DEFAULT 'active', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS astronomical_observation ( observation_id TEXT PRIMARY KEY, target_name TEXT NOT NULL, target_type TEXT, tool_type TEXT, location TEXT, education_type TEXT, max_participants INTEGER DEFAULT 20, registered_count INTEGER DEFAULT 0, description TEXT, status TEXT DEFAULT 'scheduled', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS observation_records ( record_id TEXT PRIMARY KEY, observation_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, observation_date TEXT, data_collected TEXT, notes TEXT, status TEXT DEFAULT 'completed', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS aerospace_projects ( project_id TEXT PRIMARY KEY, project_name TEXT NOT NULL, project_type TEXT, education_type TEXT, grade_level INTEGER, description TEXT, objectives TEXT, duration_days INTEGER DEFAULT 30, budget REAL DEFAULT 0, team_size INTEGER DEFAULT 5, status TEXT DEFAULT 'planning', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS project_details ( detail_id TEXT PRIMARY KEY, project_id TEXT NOT NULL, phase_name TEXT NOT NULL, phase_order INTEGER DEFAULT 1, start_date TEXT, end_date TEXT, milestones TEXT, resources TEXT, status TEXT DEFAULT 'pending', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS satellite_mission ( mission_id TEXT PRIMARY KEY, mission_name TEXT NOT NULL, satellite_type TEXT, education_type TEXT, orbit_type TEXT, launch_date TEXT, expected_duration_days INTEGER, objectives TEXT, status TEXT DEFAULT 'planned', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS mission_data ( data_id TEXT PRIMARY KEY, mission_id TEXT NOT NULL, data_type TEXT, data_content TEXT, collection_time TEXT, file_url TEXT, status TEXT DEFAULT 'processed', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS space_experiments ( experiment_id TEXT PRIMARY KEY, experiment_name TEXT NOT NULL, experiment_type TEXT, education_type TEXT, grade_level INTEGER, description TEXT, objectives TEXT, required_equipment TEXT, duration_hours REAL DEFAULT 2, safety_requirements TEXT, status TEXT DEFAULT 'planned', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS experiment_results ( result_id TEXT PRIMARY KEY, experiment_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, experiment_date TEXT, data TEXT, observations TEXT, conclusion TEXT, score REAL, status TEXT DEFAULT 'completed', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS deep_space_mission ( mission_id TEXT PRIMARY KEY, mission_name TEXT NOT NULL, target_body TEXT, mission_type TEXT, education_type TEXT, launch_window TEXT, mission_duration_days INTEGER, objectives TEXT, spacecraft TEXT, status TEXT DEFAULT 'planned', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS mission_status ( status_id TEXT PRIMARY KEY, mission_id TEXT NOT NULL, phase TEXT, status TEXT DEFAULT 'in_progress', progress_percent REAL DEFAULT 0, milestone TEXT, update_time TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS space_education ( education_id TEXT PRIMARY KEY, activity_name TEXT NOT NULL, activity_type TEXT, education_type TEXT, grade_level INTEGER, description TEXT, location TEXT, start_date TEXT, end_date TEXT, max_participants INTEGER DEFAULT 50, registered_count INTEGER DEFAULT 0, fee REAL DEFAULT 0, status TEXT DEFAULT 'scheduled', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS education_events ( event_id TEXT PRIMARY KEY, education_id TEXT NOT NULL, student_id INTEGER NOT NULL, student_name TEXT, register_date TEXT, attended INTEGER DEFAULT 0, feedback TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS space_innovation ( innovation_id TEXT PRIMARY KEY, project_name TEXT NOT NULL, innovation_type TEXT, education_type TEXT, description TEXT, objectives TEXT, feasibility REAL DEFAULT 0, impact REAL DEFAULT 0, status TEXT DEFAULT 'idea', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS innovation_projects ( project_id TEXT PRIMARY KEY, innovation_id TEXT NOT NULL, team_name TEXT, team_members TEXT, timeline TEXT, budget REAL DEFAULT 0, resources TEXT, status TEXT DEFAULT 'active', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS space_resources ( resource_id TEXT PRIMARY KEY, resource_name TEXT NOT NULL, resource_type TEXT, location TEXT, quantity INTEGER DEFAULT 0, unit TEXT, status TEXT DEFAULT 'available', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS resource_management ( management_id TEXT PRIMARY KEY, resource_id TEXT NOT NULL, transaction_type TEXT, quantity INTEGER, user_id INTEGER, user_name TEXT, transaction_date TEXT, notes TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS space_research ( research_id TEXT PRIMARY KEY, research_name TEXT NOT NULL, research_type TEXT, education_type TEXT, description TEXT, objectives TEXT, methodology TEXT, status TEXT DEFAULT 'ongoing', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS research_publications ( publication_id TEXT PRIMARY KEY, research_id TEXT NOT NULL, title TEXT NOT NULL, authors TEXT, journal TEXT, publication_date TEXT, doi TEXT, abstract TEXT, status TEXT DEFAULT 'published', created_at TEXT ) ''')
                conn.commit()
    ...
    def create_space_course(self, course_name: str, course_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO space_courses ( course_id, course_name, course_type, education_type, grade_level, subject, description, duration_hours, credits, teacher_id, teacher_name, max_students, enrolled_count, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, 'active', ?, ?) ''', (course_id, course_name, course_type,
    ...
    def enroll_space_course(self, course_id: str, student_id: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT max_students, enrolled_count, status FROM space_courses WHERE course_id = ?',
                    (course_id,))
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT INTO course_modules ( module_id, course_id, module_name, module_order, duration_hours, content, resources, status, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 'active', ?) ''', (module_id, course_id, module_name, count + 1,
    ...
    def create_observation(self, target_name: str, tool_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO astronomical_observation ( observation_id, target_name, target_type, tool_type, location, education_type, max_participants, registered_count, description, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 0, ?, 'scheduled', ?, ?) ''', (observation_id, target_name, kwargs.get('target_type'),
    ...
    def list_observations(self, education_type: str = None, tool_type: str = None,
        ...
        try:
            with self._get_connection() as conn:
                ...
                return {'success': True, 'observations': observations, 'total': total, 'page': page,
                'page_size': page_size}
        except Exception as e:
    ...
    def create_aerospace_project(self, project_name: str, project_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO aerospace_projects ( project_id, project_name, project_type, education_type, grade_level, description, objectives, duration_days, budget, team_size, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'planning', ?, ?) ''', (project_id, project_name, project_type,
                          kwargs.get('education_type'), kwargs.get('grade_level'),
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    count = cursor.fetchone()[0]
                    cursor.execute(''' INSERT INTO project_details ( detail_id, project_id, phase_name, phase_order, start_date, end_date, milestones, resources, status, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?) ''', (detail_id, project_id, phase_name, count + 1,
    ...
    def create_satellite_mission(self, mission_name: str, satellite_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO satellite_mission ( mission_id, mission_name, satellite_type, education_type, orbit_type, launch_date, expected_duration_days, objectives, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'planned', ?, ?) ''', (mission_id, mission_name, satellite_type,
    ...
    def add_mission_data(self, mission_id: str, data_type: str, data_content: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO mission_data ( data_id, mission_id, data_type, data_content, collection_time, file_url, status, created_at ) VALUES (?, ?, ?, ?, ?, ?, 'processed', ?) ''', (data_id, mission_id, data_type, data_content,
    ...
    def create_space_experiment(self, experiment_name: str, experiment_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO space_experiments ( experiment_id, experiment_name, experiment_type, education_type, grade_level, description, objectives, required_equipment, duration_hours, safety_requirements, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'planned', ?, ?) ''', (experiment_id, experiment_name, experiment_type,
                          kwargs.get('education_type'), kwargs.get('grade_level'),
                          kwargs.get('description'), kwargs.get('objectives'),
    ...
    def record_experiment_result(self, experiment_id: str, student_id: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO experiment_results ( result_id, experiment_id, student_id, student_name, experiment_date, data, observations, conclusion, score, status, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'completed', ?) ''', (result_id, experiment_id, student_id, student_name,
    ...
    def list_space_experiments(self, education_type: str = None, experiment_type: str = None,
        ...
        try:
            with self._get_connection() as conn:
                ...
                return {'success': True, 'experiments': experiments, 'total': total, 'page': page,
                'page_size': page_size}
        except Exception as e:
    ...
    def create_deep_space_mission(self, mission_name: str, target_body: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO deep_space_mission ( mission_id, mission_name, target_body, mission_type, education_type, launch_window, mission_duration_days, objectives, spacecraft, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'planned', ?, ?) ''', (mission_id, mission_name, target_body, kwargs.get('mission_type'),
    ...
    def update_mission_status(self, mission_id: str, phase: str, status: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO mission_status ( status_id, mission_id, phase, status, progress_percent, milestone, update_time, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ''', (status_id, mission_id, phase, status,
    ...
    def list_mission_status(self, mission_id: str, page: int = 1,
        ...
        try:
            with self._get_connection() as conn:
                ...
                return {'success': True, 'status_list': status_list, 'total': total, 'page': page,
                'page_size': page_size}
        except Exception as e:
    ...
    def create_space_education(self, activity_name: str, activity_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO space_education ( education_id, activity_name, activity_type, education_type, grade_level, description, location, start_date, end_date, max_participants, registered_count, fee, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, ?, 'scheduled', ?, ?) ''', (education_id, activity_name, activity_type,
                          kwargs.get('education_type'), kwargs.get('grade_level'),
    ...
    def create_innovation(self, project_name: str, innovation_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO space_innovation ( innovation_id, project_name, innovation_type, education_type, description, objectives, feasibility, impact, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'idea', ?, ?) ''', (innovation_id, project_name, innovation_type,
    ...
    def develop_innovation(self, innovation_id: str, team_name: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO innovation_projects ( project_id, innovation_id, team_name, team_members, timeline, budget, resources, status, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 'active', ?) ''', (project_id, innovation_id, team_name,
    ...
    def list_space_innovations(self, education_type: str = None, innovation_type: str = None,
        ...
        try:
            with self._get_connection() as conn:
                ...
                return {'success': True, 'innovations': innovations, 'total': total, 'page': page,
                'page_size': page_size}
        except Exception as e:
    ...
    def add_space_resource(self, resource_name: str, resource_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO space_resources ( resource_id, resource_name, resource_type, location, quantity, unit, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, 'available', ?, ?) ''', (resource_id, resource_name, resource_type,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT INTO resource_management ( management_id, resource_id, transaction_type, quantity, user_id, user_name, transaction_date, notes, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) ''', (management_id, resource_id, transaction_type, quantity,
