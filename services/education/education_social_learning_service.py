...
class EducationSocialLearningService:
    ...
    def _init_db(self):
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute(''' CREATE TABLE IF NOT EXISTS learning_communities ( community_id TEXT PRIMARY KEY, community_name TEXT NOT NULL, community_type TEXT NOT NULL, education_type TEXT NOT NULL, description TEXT, owner_id INTEGER, owner_name TEXT, member_count INTEGER DEFAULT 1, topic_count INTEGER DEFAULT 0, post_count INTEGER DEFAULT 0, is_active INTEGER DEFAULT 1, cover_image TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS community_members ( id INTEGER PRIMARY KEY AUTOINCREMENT, community_id TEXT NOT NULL, user_id INTEGER NOT NULL, user_name TEXT, role TEXT DEFAULT 'member', join_date TEXT, last_active_date TEXT, contribution_score INTEGER DEFAULT 0, UNIQUE(community_id, user_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS learning_groups ( group_id TEXT PRIMARY KEY, group_name TEXT NOT NULL, group_type TEXT NOT NULL, education_type TEXT NOT NULL, description TEXT, leader_id INTEGER, leader_name TEXT, member_count INTEGER DEFAULT 1, task_count INTEGER DEFAULT 0, discussion_count INTEGER DEFAULT 0, max_members INTEGER DEFAULT 20, is_active INTEGER DEFAULT 1, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS group_members ( id INTEGER PRIMARY KEY AUTOINCREMENT, group_id TEXT NOT NULL, user_id INTEGER NOT NULL, user_name TEXT, role TEXT DEFAULT 'member', join_date TEXT, contribution_score INTEGER DEFAULT 0, UNIQUE(group_id, user_id) ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS learning_interactions ( interaction_id TEXT PRIMARY KEY, interaction_type TEXT NOT NULL, education_type TEXT NOT NULL, title TEXT, description TEXT, initiator_id INTEGER, initiator_name TEXT, community_id TEXT, group_id TEXT, participant_count INTEGER DEFAULT 0, comment_count INTEGER DEFAULT 0, like_count INTEGER DEFAULT 0, status TEXT DEFAULT 'active', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS interaction_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, interaction_id TEXT NOT NULL, user_id INTEGER NOT NULL, user_name TEXT, action_type TEXT, content TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS knowledge_sharing ( sharing_id TEXT PRIMARY KEY, sharing_type TEXT NOT NULL, education_type TEXT NOT NULL, title TEXT NOT NULL, content TEXT, author_id INTEGER, author_name TEXT, community_id TEXT, group_id TEXT, tags TEXT, view_count INTEGER DEFAULT 0, download_count INTEGER DEFAULT 0, like_count INTEGER DEFAULT 0, comment_count INTEGER DEFAULT 0, file_url TEXT, status TEXT DEFAULT 'published', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS sharing_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, sharing_id TEXT NOT NULL, user_id INTEGER NOT NULL, user_name TEXT, action_type TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS collaborative_learning ( collaboration_id TEXT PRIMARY KEY, collaboration_type TEXT NOT NULL, education_type TEXT NOT NULL, title TEXT NOT NULL, description TEXT, leader_id INTEGER, leader_name TEXT, group_id TEXT, progress INTEGER DEFAULT 0, status TEXT DEFAULT 'active', start_date TEXT, end_date TEXT, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS collaboration_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, collaboration_id TEXT NOT NULL, user_id INTEGER NOT NULL, user_name TEXT, role TEXT, contribution TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS peer_support ( support_id TEXT PRIMARY KEY, support_type TEXT NOT NULL, education_type TEXT NOT NULL, title TEXT, description TEXT, requester_id INTEGER, requester_name TEXT, supporter_id INTEGER, supporter_name TEXT, community_id TEXT, status TEXT DEFAULT 'pending', created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS support_records ( id INTEGER PRIMARY KEY AUTOINCREMENT, support_id TEXT NOT NULL, user_id INTEGER NOT NULL, user_name TEXT, action_type TEXT, content TEXT, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS social_evaluation ( evaluation_id TEXT PRIMARY KEY, evaluation_type TEXT NOT NULL, education_type TEXT NOT NULL, target_id INTEGER, target_name TEXT, evaluator_id INTEGER, evaluator_name TEXT, score REAL, comment TEXT, is_anonymous INTEGER DEFAULT 0, status TEXT DEFAULT 'completed', created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS evaluation_results ( id INTEGER PRIMARY KEY AUTOINCREMENT, evaluation_id TEXT NOT NULL, dimension TEXT, score REAL, weight REAL, feedback TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS learning_network ( network_id TEXT PRIMARY KEY, network_type TEXT NOT NULL, education_type TEXT NOT NULL, name TEXT, description TEXT, node_count INTEGER DEFAULT 0, edge_count INTEGER DEFAULT 0, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS network_relations ( id INTEGER PRIMARY KEY AUTOINCREMENT, network_id TEXT NOT NULL, source_id INTEGER NOT NULL, target_id INTEGER NOT NULL, relation_type TEXT, weight REAL DEFAULT 1.0, created_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS social_alerts ( alert_id TEXT PRIMARY KEY, alert_type TEXT NOT NULL, education_type TEXT NOT NULL, title TEXT, description TEXT, target_user_id INTEGER, trigger_condition TEXT, severity TEXT DEFAULT 'medium', is_active INTEGER DEFAULT 1, created_at TEXT, updated_at TEXT ) ''')
                cursor.execute(''' CREATE TABLE IF NOT EXISTS alert_history ( id INTEGER PRIMARY KEY AUTOINCREMENT, alert_id TEXT NOT NULL, user_id INTEGER, message TEXT, status TEXT DEFAULT 'sent', sent_at TEXT ) ''')
                conn.commit()
    ...
    def create_community(self, community_name: str, community_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO learning_communities ( community_id, community_name, community_type, education_type, description, owner_id, owner_name, member_count, topic_count, post_count, is_active, cover_image, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 1, 0, 0, 1, ?, ?, ?) ''', (community_id, community_name, community_type,
                          education_type, kwargs.get('description'),
                          owner_id, owner_name, kwargs.get('cover_image'),
                          now, now))
                    cursor.execute(''' INSERT INTO community_members ( community_id, user_id, user_name, role, join_date, last_active_date, contribution_score ) VALUES (?, ?, ?, 'owner', ?, ?, 0) ''', (community_id, owner_id, owner_name, now[:10], now[:10]))
                    conn.commit()
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT OR IGNORE INTO community_members ( community_id, user_id, user_name, role, join_date, last_active_date, contribution_score ) VALUES (?, ?, ?, 'member', ?, ?, 0) ''', (community_id, user_id, user_name, now[:10], now[:10]))
    ...
    def list_communities(self, education_type: str = None,
        ...
        try:
            with self._get_connection() as conn:
                ...
                return {'success': True, 'communities': communities, 'total': total, 'page': page,
                'page_size': page_size}
        except Exception as e:
    ...
    def create_group(self, group_name: str, group_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO learning_groups ( group_id, group_name, group_type, education_type, description, leader_id, leader_name, member_count, task_count, discussion_count, max_members, is_active, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, 1, 0, 0, ?, 1, ?, ?) ''', (group_id, group_name, group_type, education_type,
                          kwargs.get('description'), leader_id, leader_name,
                          kwargs.get('max_members', 20), now, now))
                    cursor.execute(''' INSERT INTO group_members ( group_id, user_id, user_name, role, join_date, contribution_score ) VALUES (?, ?, ?, 'leader', ?, 0) ''', (group_id, leader_id, leader_name, now[:10]))
                    conn.commit()
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT OR IGNORE INTO group_members ( group_id, user_id, user_name, role, join_date, contribution_score ) VALUES (?, ?, ?, 'member', ?, 0) ''', (group_id, user_id, user_name, now[:10]))
                    if cursor.rowcount > 0:
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(
                    'UPDATE group_members SET contribution_score = contribution_score + 1 WHERE group_id = ? AND  user_id = ?', (group_id, user_id))
                    conn.commit()
                    return {'success': True}
        except Exception as e:
    ...
    def create_interaction(self, interaction_type: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO learning_interactions ( interaction_id, interaction_type, education_type, title, description, initiator_id, initiator_name, community_id, group_id, participant_count, comment_count, like_count, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 1, 0, 0, 'active', ?, ?) ''', (interaction_id, interaction_type, education_type,
                          title, kwargs.get('description'), initiator_id,
                          initiator_name, kwargs.get('community_id'),
                          kwargs.get('group_id'), now, now))
                    cursor.execute(''' INSERT INTO interaction_records ( interaction_id, user_id, user_name, action_type, content, created_at ) VALUES (?, ?, ?, 'initiate', ?, ?) ''', (interaction_id, initiator_id, initiator_name, title, now))
                    conn.commit()
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT INTO interaction_records ( interaction_id, user_id, user_name, action_type, content, created_at ) VALUES (?, ?, ?, 'participate', ?, ?) ''', (interaction_id, user_id, user_name, content or '', now))
                    conn.commit()
                    return {'success': True}
        except Exception as e:
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT INTO interaction_records ( interaction_id, user_id, user_name, action_type, content, created_at ) VALUES (?, ?, ?, 'comment', ?, ?) ''', (interaction_id, user_id, user_name, content, now))
                    conn.commit()
                    return {'success': True}
        except Exception as e:
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    cursor.execute(''' INSERT INTO interaction_records ( interaction_id, user_id, user_name, action_type, content, created_at ) VALUES (?, ?, ?, 'like', '', ?) ''', (interaction_id, user_id, '', now))
                    conn.commit()
                    return {'success': True}
        except Exception as e:
    ...
    def publish_knowledge(self, sharing_type: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO knowledge_sharing ( sharing_id, sharing_type, education_type, title, content, author_id, author_name, community_id, group_id, tags, view_count, download_count, like_count, comment_count, file_url, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, 0, 0, 0, ?, 'published', ?, ?) ''', (sharing_id, sharing_type, education_type, title,
    ...
    def create_collaboration(self, collaboration_type: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO collaborative_learning ( collaboration_id, collaboration_type, education_type, title, description, leader_id, leader_name, group_id, progress, status, start_date, end_date, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 0, 'active', ?, ?, ?, ?) ''', (collaboration_id, collaboration_type, education_type,
                    ...
                    cursor.execute(''' INSERT INTO collaboration_records ( collaboration_id, user_id, user_name, role, contribution, created_at ) VALUES (?, ?, ?, 'leader', ?, ?) ''', (collaboration_id, leader_id, leader_name, '', now))
                    conn.commit()
    ...
    def join_collaboration(self, collaboration_id: str, user_id: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT status FROM collaborative_learning WHERE collaboration_id = ?',
                    (collaboration_id,))
                    ...
                    cursor.execute(''' INSERT OR IGNORE INTO collaboration_records ( collaboration_id, user_id, user_name, role, contribution, created_at ) VALUES (?, ?, ?, ?, '', ?) ''', (collaboration_id, user_id, user_name, role, now))
                    if cursor.rowcount > 0:
                        conn.commit()
                        return {'success': True}
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                    'UPDATE collaboration_records SET contribution = ? WHERE collaboration_id = ? AND user_id = ?',
    ...
    def request_peer_support(self, support_type: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO peer_support ( support_id, support_type, education_type, title, description, requester_id, requester_name, supporter_id, supporter_name, community_id, status, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, NULL, NULL, ?, 'pending', ?, ?) ''', (support_id, support_type, education_type, title,
    ...
    def create_evaluation(self, evaluation_type: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO social_evaluation ( evaluation_id, evaluation_type, education_type, target_id, target_name, evaluator_id, evaluator_name, score, comment, is_anonymous, status, created_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'completed', ?) ''', (evaluation_id, evaluation_type, education_type,
                    ...
                    for dim in dimensions:
                        cursor.execute('INSERT INTO evaluation_results (evaluation_id, dimension, score, weight, feedback) VALUES (?, ?, ?, ?, ?)',
                                     (evaluation_id, dim.get('dimension'), dim.get('score'), dim.get('weight', 1.0),
                                     dim.get('feedback', '')))
                    conn.commit()
    ...
    def create_network(self, network_type: str, education_type: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO learning_network ( network_id, network_type, education_type, name, description, node_count, edge_count, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, 0, 0, ?, ?) ''', (network_id, network_type, education_type, name,
    ...
    def add_network_relation(self, network_id: str, source_id: int,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute('SELECT node_count, edge_count FROM learning_network WHERE network_id = ?',
                    (network_id,))
                    network = cursor.fetchone()
                    if not network:
                        return {'success': False, 'error': '网络不存在'}
                    cursor.execute(''' INSERT OR REPLACE INTO network_relations ( network_id, source_id, target_id, relation_type, weight, created_at ) VALUES (?, ?, ?, ?, ?, ?) ''', (network_id, source_id, target_id, relation_type, weight, now))
    ...
    def recommend_connections(self, user_id: int, education_type: str,
        ...
        try:
            with self._get_connection() as conn:
                cursor = conn.cursor()
                cursor.execute(''' SELECT target_id, COUNT(*) as connection_count FROM network_relations WHERE source_id IN ( SELECT target_id FROM network_relations WHERE source_id = ? ) AND target_id != ? GROUP BY target_id ORDER BY connection_count DESC LIMIT ? ''', (user_id, user_id, limit))
    ...
    def create_alert(self, alert_type: str, education_type: str, title: str,
        ...
        try:
            ...
            with self._lock:
                with self._get_connection() as conn:
                    cursor = conn.cursor()
                    cursor.execute(''' INSERT INTO social_alerts ( alert_id, alert_type, education_type, title, description, target_user_id, trigger_condition, severity, is_active, created_at, updated_at ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 1, ?, ?) ''', (alert_id, alert_type, education_type, title,
    ...
    def get_learning_statistics(self, education_type: str = None,
        ...
        try:
            with self._get_connection() as conn:
                ...
                cursor.execute('SELECT COUNT(*) FROM learning_communities WHERE education_type = ?',
                (education_type or 'k12',))
                stats['community_count'] = cursor.fetchone()[0]

                cursor.execute('SELECT COUNT(*) FROM learning_groups WHERE education_type = ?',
                (education_type or 'k12',))
                stats['group_count'] = cursor.fetchone()[0]

                cursor.execute('SELECT COUNT(*) FROM learning_interactions WHERE education_type = ?',
                (education_type or 'k12',))
                stats['interaction_count'] = cursor.fetchone()[0]

                cursor.execute('SELECT COUNT(*) FROM knowledge_sharing WHERE education_type = ?',
                (education_type or 'k12',))
                stats['knowledge_count'] = cursor.fetchone()[0]

                cursor.execute('SELECT COUNT(*) FROM collaborative_learning WHERE education_type = ?',
                (education_type or 'k12',))
                ...
                cursor.execute('SELECT COUNT(*) FROM social_evaluation WHERE education_type = ?',
                (education_type or 'k12',))
                stats['evaluation_count'] = cursor.fetchone()[0]

                cursor.execute('SELECT COUNT(*) FROM learning_network WHERE education_type = ?',
                (education_type or 'k12',))
